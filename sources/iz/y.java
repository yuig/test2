...
public abstract class y extends hz.d {

    /* renamed from: s0, reason: collision with root package name */
    public ye2.m f73890s0;

    /* renamed from: t0, reason: collision with root package name */
    public boolean f73891t0;

    /* renamed from: u0, reason: collision with root package name */
    public boolean f73892u0 = false;
    ...
    public final void a8() {
        ...
        a1.G(jVar, (cz.e) oaVar.V9.get());
        a1.R(jVar, s8Var.Z4());
    }

    @Override // hz.j, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f73891t0) {
            return null;
        }
        i8();
        return this.f73890s0;
    }

    public final void i8() {
        if (this.f73890s0 == null) {
            this.f73890s0 = new ye2.m(super.getContext(), this);
            this.f73891t0 = ue.c.x(super.getContext());
        }
    }
