...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f103199v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f103200w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f103201x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f103202y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f103200w0 == null) {
            synchronized (this.f103201x0) {
                try {
                    if (this.f103200w0 == null) {
                        this.f103200w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f103200w0;
    }

    public final void S8() {
        if (this.f103198u0 == null) {
            this.f103198u0 = new m(super.getContext(), this);
            this.f103199v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        c0.d.R1(eVar, (k) oaVar.f113921t1.get());
        c0.d.D1(eVar, (uk1.e) oaVar.f113702ga.get());
        c0.d.o0(eVar, (mr1.a) oaVar.B6.get());
        c0.d.Y0(eVar, (mo1.d) oaVar.D5.get());
        c0.d.M1(eVar, (x10.d) oaVar.f113997x5.get());
        c0.d.T1(eVar, (UserDeserializer) oaVar.f113905s3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f103199v0) {
            return null;
        }
        S8();
        return this.f103198u0;
    }
