...
public final class ei1 implements a.cd {

    /* renamed from: a, reason: collision with root package name */
    public final xf1 f4865a;

    public ei1(xf1 nativeAdCore) {
        Intrinsics.checkNotNullParameter(nativeAdCore, "nativeAdCore");
        this.f4865a = nativeAdCore;
    }
    ...
    public final Object a(ym0 ym0Var, Map map, bl2.c cVar) {
        nm.u uVar;
        xf1 xf1Var;
        a.pf pfVar = (a.pf) this.f4865a.f13640b.get();
        if (pfVar != null) {
            ...
            synchronized (yh1Var) {
                if (yh1Var.f14249d.get()) {
                    ...
                    if (internalNativeAd == null || (xf1Var = internalNativeAd.f32087o) == null) {
                        ...
                        uVar = xf1Var.a(frameLayout, scaleType, linkedHashMap);
                    }
                }
            }
        } else {
        ...
        Object a13 = ym0Var.a(uVar, "nativeAdViewSignalsReady", cVar);
        return a13 == cl2.a.COROUTINE_SUSPENDED ? a13 : Unit.f80348a;
    }

    @Override // a.cd
    public final kl0 b() {
        return kl0.GMSG_NATIVE_AD_VIEW_SIGNALS;
    }
}
