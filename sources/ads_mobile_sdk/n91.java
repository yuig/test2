...
public final class n91 extends s implements Function1 {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ u91 f8726a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n91(u91 u91Var) {
        super(1);
        this.f8726a = u91Var;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        u91 u91Var = this.f8726a;
        synchronized (u91Var) {
            Intrinsics.checkNotNullParameter(mediationAd, "<set-?>");
            u91Var.f11895f = mediationAd;
            unit = Unit.f80348a;
        }
        return unit;
    }
