...
public abstract class a extends nl1.d implements af2.c {
    ...
    public final Object f22825a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f22826b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f22825a0) {
                try {
                    if (this.Z == null) {
    ...
    public void X7() {
        ...
        pe.i.p0(pVar, (i2) oaVar.F3.get());
        pe.i.E0(pVar, s8Var.p6());
        pe.i.T(pVar, (e02.a) oaVar.f113757jd.get());
        pe.i.a0(pVar, (il1.a) s8Var.f114581z.get());
        pe.i.i0(pVar, s8Var.M6());
    }
