...
public abstract class k extends yk1.k implements af2.c {
    ...
    public boolean f97975f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f97976g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f97977h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f97978i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f97976g0 == null) {
            synchronized (this.f97977h0) {
                try {
                    if (this.f97976g0 == null) {
                        this.f97976g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f97976g0;
    }

    public final void Z7() {
        if (this.f97974e0 == null) {
            this.f97974e0 = new m(super.getContext(), this);
            this.f97975f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f97975f0) {
            return null;
        }
        Z7();
        return this.f97974e0;
    }
