...
public final class q extends com.pinterest.shuffles.scene.composer.c {

    /* renamed from: y, reason: collision with root package name */
    public static final ql2.g f15685y = new ql2.g(32.0f, 2048.0f);
    ...
    public float f15692u = 100.0f;

    /* renamed from: v, reason: collision with root package name */
    public final v f15693v = xk2.m.b(new jh0.d(this, 20));

    /* renamed from: w, reason: collision with root package name */
    public StaticLayout f15694w;

    /* renamed from: x, reason: collision with root package name */
    public float f15695x;
    ...
    public final void g(float f13) {
        int i13 = z.f52181a;
        float f14 = (this.f15690s / 375.0f) * f13;
        float floatValue = ((Number) this.f15693v.getValue()).floatValue() * f14;
        float f15 = this.f15692u * f14;
        StaticLayout h10 = h(f15, floatValue);
        if (((int) f15) < h10.getWidth()) {
            h10 = h(f15, floatValue);
        }
        this.f15694w = h10;
        l2 l2Var = this.f15688q;
        if (l2Var == null) {
            Intrinsics.r("textData");
            throw null;
        }
        float f16 = l2Var.f106542c != null ? floatValue * 0.2f : 2.0f;
        this.f15695x = f16;
        this.f15686o = (2 * f16) + f15;
        if (h10 != null) {
            this.f15687p = h10.getHeight();
        } else {
    ...
    public final StaticLayout h(float f13, float f14) {
        TextPaint textPaint = this.f15689r;
        if (textPaint == null) {
            Intrinsics.r("textPaint");
            throw null;
        }
        textPaint.setTextSize(f14);
        TextPaint textPaint2 = this.f15689r;
        if (textPaint2 == null) {
            Intrinsics.r("textPaint");
            throw null;
        }
        ...
        TextPaint textPaint3 = this.f15689r;
        if (textPaint3 == null) {
            Intrinsics.r("textPaint");
            throw null;
        }
        int i14 = (int) f13;
        StaticLayout.Builder maxLines = StaticLayout.Builder.obtain(str, 0, length, textPaint3, i14).setEllipsizedWidth(i14).setEllipsize(TextUtils.TruncateAt.END).setMaxLines(1);
        l2 l2Var3 = this.f15688q;
        if (l2Var3 == null) {
            Intrinsics.r("textData");
            throw null;
        }
        int i15 = iArr[l2Var3.f106545f.ordinal()];
    ...
    public final void i(float f13, float f14) {
        ...
        canvas.scale(f13 / qVar.f15686o, f14 / qVar.f15687p);
        l2 l2Var = qVar.f15688q;
        ...
        float f17 = qVar.f15695x;
        StaticLayout staticLayout = qVar.f15694w;
        ...
        int i15 = 0;
        while (i15 < lineCount) {
            StaticLayout staticLayout2 = qVar.f15694w;
            ...
            StaticLayout staticLayout3 = qVar.f15694w;
            if (staticLayout3 == null) {
                Intrinsics.r("textLayout");
                throw null;
            }
            int lineStart = staticLayout3.getLineStart(i15);
            StaticLayout staticLayout4 = qVar.f15694w;
            ...
            Rect rect = new Rect();
            StaticLayout staticLayout5 = qVar.f15694w;
            ...
            Rect rect2 = new Rect();
            TextPaint textPaint = qVar.f15689r;
            if (textPaint == null) {
                Intrinsics.r("textPaint");
                throw null;
            }
            textPaint.setTextAlign(Paint.Align.LEFT);
            TextPaint textPaint2 = qVar.f15689r;
            if (textPaint2 == null) {
                Intrinsics.r("textPaint");
                throw null;
            }
            ...
            if (valueOf == null || obj.length() <= 0) {
                ...
                l2 l2Var2 = qVar.f15688q;
                if (l2Var2 == null) {
                    Intrinsics.r(str3);
                    throw null;
                }
                int i16 = p.f15684a[l2Var2.f106545f.ordinal()];
                ...
                rectF = rectF7;
                float f23 = 2;
                RectF rectF8 = new RectF(width, f19, (qVar.f15695x * f23) + width2 + width, rectF6.height() + f19);
            ...
            RectF rectF11 = rectF;
            float f75 = (rectF10.left - rectF11.left) + this.f15695x;
            ...
            try {
                ...
                int i17 = p.f15684a[l2Var3.f106545f.ordinal()];
