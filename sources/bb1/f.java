...
public abstract class f extends yk1.k implements af2.c {
    ...
    public ye2.m f22490e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f22491f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f22492g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f22493h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f22494i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f22492g0 == null) {
            synchronized (this.f22493h0) {
                try {
                    if (this.f22492g0 == null) {
                        this.f22492g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f22492g0;
    }

    public final void Z7() {
        if (this.f22490e0 == null) {
            this.f22490e0 = new ye2.m(super.getContext(), this);
            this.f22491f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        zVar.f91285j = (f0) oaVar.f113747j2.get();
        ...
        kg.t.y0(zVar, (uk1.e) oaVar.f113702ga.get());
        kg.t.V(zVar, (cr1.a) oaVar.A2.get());
        kg.t.F0(zVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f22491f0) {
            return null;
        }
        Z7();
