...
public abstract class c extends yk1.k implements af2.c {
    ...
    public ye2.m f22475e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f22476f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f22477g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f22478h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f22479i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f22477g0 == null) {
            synchronized (this.f22478h0) {
                try {
                    if (this.f22477g0 == null) {
                        this.f22477g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f22477g0;
    }

    public final void Z7() {
        if (this.f22475e0 == null) {
            this.f22475e0 = new ye2.m(super.getContext(), this);
            this.f22476f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        g3.E1(pVar, (uk1.e) oaVar.f113702ga.get());
        g3.W1(pVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f22476f0) {
            return null;
        }
        Z7();
