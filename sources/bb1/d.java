...
public abstract class d extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f22480e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f22481f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f22482g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f22483h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f22484i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f22482g0 == null) {
            synchronized (this.f22483h0) {
                try {
                    if (this.f22482g0 == null) {
                        this.f22482g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f22482g0;
    }

    public final void Z7() {
        if (this.f22480e0 == null) {
            this.f22480e0 = new ye2.m(super.getContext(), this);
            this.f22481f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        ph.a.n0(sVar, (uk1.e) oaVar.f113702ga.get());
        ph.a.r0(sVar, (i92.k) oaVar.f113921t1.get());
        ph.a.g0(sVar, (cr1.a) oaVar.A2.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f22481f0) {
            return null;
        }
        Z7();
        return this.f22480e0;
    }
