...
public abstract class a extends yk1.k implements af2.c {
    ...
    public ye2.m f22465e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f22466f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f22467g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f22468h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f22469i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f22467g0 == null) {
            synchronized (this.f22468h0) {
                try {
                    if (this.f22467g0 == null) {
                        this.f22467g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
    ...
    public final void Z7() {
        if (this.f22465e0 == null) {
            this.f22465e0 = new ye2.m(super.getContext(), this);
            this.f22466f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        b0.f1(iVar, (uk1.e) oaVar.f113702ga.get());
        b0.A0(iVar, (cr1.a) oaVar.A2.get());
        b0.p1(iVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f22466f0) {
            return null;
        }
        Z7();
        return this.f22465e0;
    }
