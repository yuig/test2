...
public abstract class g extends k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public m f92971e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f92972f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile h f92973g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f92974h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f92975i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f92973g0 == null) {
            synchronized (this.f92974h0) {
                try {
                    if (this.f92973g0 == null) {
                        this.f92973g0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f92973g0;
    }

    public final void Z7() {
        if (this.f92971e0 == null) {
            this.f92971e0 = new m(super.getContext(), this);
            this.f92972f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f92972f0) {
            return null;
        }
        Z7();
        return this.f92971e0;
    }
