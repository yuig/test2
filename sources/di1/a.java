...
public abstract class a extends k implements af2.c {
    ...
    public boolean f55044f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f55045g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f55046h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f55047i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f55045g0 == null) {
            synchronized (this.f55046h0) {
                try {
                    if (this.f55045g0 == null) {
                        this.f55045g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f55045g0;
    }

    public final void Z7() {
        if (this.f55043e0 == null) {
            this.f55043e0 = new m(super.getContext(), this);
            this.f55044f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public void a8() {
        ...
        b0.r1(gVar, (i92.k) oaVar.f113921t1.get());
        b0.g1(gVar, (uk1.e) oaVar.f113702ga.get());
        b0.I0(gVar, (a11.d) oaVar.f113668ec.get());
        b0.v1(gVar, (z3) s8Var.f114238bc.get());
        b0.S0(gVar, s8Var.M6());
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f55044f0) {
            return null;
        }
        Z7();
        return this.f55043e0;
    }
