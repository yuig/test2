...
public final class CredentialProviderCreatePublicKeyCredentialController$handleResponse$6 extends s implements Function0<Unit> {
    ...
    public static final void invoke$lambda$0(CredentialProviderCreatePublicKeyCredentialController this$0, JSONException e13) {
        ...
        if (mVar != null) {
            mVar.a(new CreatePublicKeyCredentialDomException(new f(), e13.getMessage()));
        } else {
