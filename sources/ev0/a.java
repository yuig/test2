...
public abstract class a extends yk1.k implements af2.c {
    ...
    public ye2.m f60232e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f60233f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f60234g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f60235h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f60236i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f60234g0 == null) {
            synchronized (this.f60235h0) {
                try {
                    if (this.f60234g0 == null) {
                        this.f60234g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f60234g0;
    }

    public final void Z7() {
        if (this.f60232e0 == null) {
            this.f60232e0 = new ye2.m(super.getContext(), this);
            this.f60233f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        k3.Y0(dVar, (j8) s8Var.U4.get());
        k3.a1(dVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f60233f0) {
            return null;
        }
        Z7();
        return this.f60232e0;
    }
