...
public abstract class g extends k implements af2.c {
    ...
    public boolean f98920f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile h f98921g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f98922h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f98923i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f98921g0 == null) {
            synchronized (this.f98922h0) {
                try {
                    if (this.f98921g0 == null) {
                        this.f98921g0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f98921g0;
    }

    public final void Z7() {
        if (this.f98919e0 == null) {
            this.f98919e0 = new m(super.getContext(), this);
            this.f98920f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f98920f0) {
            return null;
        }
        Z7();
        return this.f98919e0;
    }
