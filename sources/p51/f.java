...
public abstract class f<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f98899v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f98900w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f98901x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f98902y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f98900w0 == null) {
            synchronized (this.f98901x0) {
                try {
                    if (this.f98900w0 == null) {
                        this.f98900w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f98900w0;
    }

    public final void S8() {
        if (this.f98898u0 == null) {
            this.f98898u0 = new m(super.getContext(), this);
            this.f98899v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        oe.f.m0(dVar, (g0) oaVar.f113590a4.get());
        oe.f.C0(dVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f98899v0) {
            return null;
        }
        S8();
        return this.f98898u0;
    }
