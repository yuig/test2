...
public abstract class b extends k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public m f53416e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f53417f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f53418g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f53419h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f53420i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f53418g0 == null) {
            synchronized (this.f53419h0) {
                try {
                    if (this.f53418g0 == null) {
                        this.f53418g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f53418g0;
    }

    public final void Z7() {
        if (this.f53416e0 == null) {
            this.f53416e0 = new m(super.getContext(), this);
            this.f53417f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        pe.i.R(hVar, (oc.c) oaVar.f113907s5.get());
        pe.i.W(hVar, (p0) s8Var.W6.get());
        pe.i.V(hVar, s8Var.V6);
        pe.i.x0(hVar, (uk1.e) oaVar.f113702ga.get());
        pe.i.t0(hVar, (r) oaVar.f113622c1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f53417f0) {
            return null;
        }
        Z7();
        return this.f53416e0;
    }
