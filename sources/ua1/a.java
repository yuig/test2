...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f121409v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f121410w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f121411x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f121412y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f121410w0 == null) {
            synchronized (this.f121411x0) {
                try {
                    if (this.f121410w0 == null) {
                        this.f121410w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f121410w0;
    }

    public final void S8() {
        if (this.f121408u0 == null) {
            this.f121408u0 = new m(super.getContext(), this);
            this.f121409v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        l3.c.l0(dVar, (k) oaVar.f113921t1.get());
        l3.c.d0(dVar, (r3) s8Var.f114459qb.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f121409v0) {
            return null;
        }
        S8();
        return this.f121408u0;
    }
