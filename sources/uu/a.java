...
public abstract class a extends j0 {
    ...
    public boolean f123112w0;

    /* renamed from: x0, reason: collision with root package name */
    public boolean f123113x0 = false;
    ...
    public final void g8() {
        if (this.f123111v0 == null) {
            this.f123111v0 = new m(super.getContext(), this);
            this.f123112w0 = ue.c.x(super.getContext());
        }
    }

    @Override // pu.c0, mu.b0, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f123112w0) {
            return null;
        }
        g8();
        return this.f123111v0;
    }
