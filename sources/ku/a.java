...
public final class a extends i {
    ...
    public final AdsNonCollapsibleBottomSheetBehavior f80882q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a(Context context, boolean z13) {
        super(context, null, 0, z13);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f80882q = new AdsNonCollapsibleBottomSheetBehavior(context, null, z13);
    }
    ...
    @Override // cu.i
    public final void x() {
        a0.o(i(), x0.visit_profile, new Object[0]);
    }
}
