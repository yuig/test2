...
public abstract class d extends yk1.k implements af2.c {
    ...
    public ye2.m f134444e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f134445f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f134446g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f134447h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f134448i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f134446g0 == null) {
            synchronized (this.f134447h0) {
                try {
                    if (this.f134446g0 == null) {
                        this.f134446g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f134446g0;
    }

    public final void Z7() {
        if (this.f134444e0 == null) {
            this.f134444e0 = new ye2.m(super.getContext(), this);
            this.f134445f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        pp2.a.q0(tVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f134445f0) {
            return null;
        }
        Z7();
        return this.f134444e0;
    }
