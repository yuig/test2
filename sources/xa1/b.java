...
public abstract class b<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f134434u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f134435v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f134436w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f134437x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f134438y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f134436w0 == null) {
            synchronized (this.f134437x0) {
                try {
                    if (this.f134436w0 == null) {
                        this.f134436w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f134436w0;
    }

    public final void S8() {
        if (this.f134434u0 == null) {
            this.f134434u0 = new ye2.m(super.getContext(), this);
            this.f134435v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        pe.i.B0(fVar, (uk1.e) oaVar.f113702ga.get());
        pe.i.g0(fVar, (vb0.l) s8Var.f114592za.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f134435v0) {
            return null;
        }
        S8();
        return this.f134434u0;
    }
