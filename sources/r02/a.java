...
public abstract class a extends mm1.l {
    ...
    public ye2.m f105713d0;

    /* renamed from: e0, reason: collision with root package name */
    public boolean f105714e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f105715f0 = false;
    ...
    public final void c8() {
        if (this.f105713d0 == null) {
            this.f105713d0 = new ye2.m(super.getContext(), this);
            this.f105714e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f105714e0) {
            return null;
        }
        c8();
        return this.f105713d0;
    }
