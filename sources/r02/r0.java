...
public final class r0 extends dl2.j implements Function2 {
    ...
    public final /* synthetic */ s0 f105801s;
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        return new r0(this.f105801s, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i13 = this.f105800r;
        if (i13 == 0) {
            ue.c.H(obj);
            s0 s0Var = this.f105801s;
            androidx.lifecycle.z viewLifecycleOwner = s0Var.getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
            androidx.lifecycle.r rVar = androidx.lifecycle.r.STARTED;
            q0 q0Var = new q0(s0Var, null);
            this.f105800r = 1;
