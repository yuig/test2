...
public abstract class m1 extends mm1.l {

    /* renamed from: d0, reason: collision with root package name */
    public ye2.m f86673d0;

    /* renamed from: e0, reason: collision with root package name */
    public boolean f86674e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f86675f0 = false;
    ...
    public final void X7() {
        ...
        k3.F0(i0Var);
        k3.j1(i0Var, s8Var.v6());
        k3.D0(i0Var, new lh0.f0((lh0.z0) s8Var.f114255d.D0.get()));
    }

    public final void c8() {
        if (this.f86673d0 == null) {
            this.f86673d0 = new ye2.m(super.getContext(), this);
            this.f86674e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f86674e0) {
            return null;
        }
        c8();
        return this.f86673d0;
    }
