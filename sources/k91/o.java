...
public abstract class o extends yk1.k implements af2.c {
    ...
    public ye2.m f78861e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f78862f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f78863g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f78864h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f78865i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f78863g0 == null) {
            synchronized (this.f78864h0) {
                try {
                    if (this.f78863g0 == null) {
                        this.f78863g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f78863g0;
    }

    public final void Z7() {
        if (this.f78861e0 == null) {
            this.f78861e0 = new ye2.m(super.getContext(), this);
            this.f78862f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        t.o0(jVar, (uk1.e) oaVar.f113702ga.get());
        t.z(jVar, (lu1.b) oaVar.f113961v5.get());
        t.A0(jVar);
        t.z0(jVar, s8Var.K6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f78862f0) {
            return null;
        }
        Z7();
        return this.f78861e0;
    }
