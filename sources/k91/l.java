...
public abstract class l extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f78846e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f78847f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f78848g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f78849h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f78850i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f78848g0 == null) {
            synchronized (this.f78849h0) {
                try {
                    if (this.f78848g0 == null) {
                        this.f78848g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f78848g0;
    }

    public final void Z7() {
        if (this.f78846e0 == null) {
            this.f78846e0 = new ye2.m(super.getContext(), this);
            this.f78847f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        c0.d.B1(cVar, (uk1.e) oaVar.f113702ga.get());
        c0.d.n0(cVar, (mr1.a) oaVar.B6.get());
        c0.d.p0(cVar, (lu1.b) oaVar.f113961v5.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f78847f0) {
            return null;
        }
        Z7();
        return this.f78846e0;
    }
