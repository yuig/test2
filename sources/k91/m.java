...
public abstract class m extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f78851e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f78852f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f78853g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f78854h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f78855i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f78853g0 == null) {
            synchronized (this.f78854h0) {
                try {
                    if (this.f78853g0 == null) {
                        this.f78853g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f78853g0;
    }

    public final void Z7() {
        if (this.f78851e0 == null) {
            this.f78851e0 = new ye2.m(super.getContext(), this);
            this.f78852f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        l3.c.k0(eVar, (i92.k) oaVar.f113921t1.get());
        l3.c.X(eVar, (mo1.d) oaVar.D5.get());
        l3.c.Q(eVar, (lu1.b) oaVar.f113961v5.get());
        l3.c.f0(eVar, s8Var.f114280ea);
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f78852f0) {
            return null;
        }
        Z7();
        return this.f78851e0;
    }
