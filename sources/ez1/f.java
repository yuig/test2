...
public abstract class f extends nl1.d implements af2.c {
    public m X;
    public boolean Y;
    public volatile h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f60714a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f60715b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.Z == null) {
            synchronized (this.f60714a0) {
                try {
                    if (this.Z == null) {
                        this.Z = new h(this);
                    }
    ...
    public final void X7() {
        ...
        j.O0(dVar, (vx.d) oaVar.f113601af.get());
        j.H0(dVar, (vx.c) oaVar.f113636cf.get());
        j.g2(dVar, (k) oaVar.f113921t1.get());
    }
