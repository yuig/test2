...
public abstract /* synthetic */ class d {
    ...
    static {
        ...
        try {
            f34769a[MFEBeforeAfterMakeupView.BeforeViewSide.RIGHT.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            f34769a[MFEBeforeAfterMakeupView.BeforeViewSide.TOP.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            f34769a[MFEBeforeAfterMakeupView.BeforeViewSide.BOTTOM.ordinal()] = 4;
