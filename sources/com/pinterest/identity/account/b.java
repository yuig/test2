...
public abstract class b extends yk1.k implements af2.c {
    ...
    public boolean f49773f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f49774g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f49775h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f49776i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f49774g0 == null) {
            synchronized (this.f49775h0) {
                try {
                    if (this.f49774g0 == null) {
                        this.f49774g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f49774g0;
    }

    public final void Z7() {
        if (this.f49772e0 == null) {
            this.f49772e0 = new m(super.getContext(), this);
            this.f49773f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        pe.i.c0(hVar, s8Var.a5());
        pe.i.O(hVar, (mr1.a) oaVar.B6.get());
        pe.i.N(hVar, s8Var.Y4());
        pe.i.e0(hVar, (mo1.d) oaVar.D5.get());
        pe.i.Y(hVar, s8Var.M5());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f49773f0) {
            return null;
        }
        Z7();
