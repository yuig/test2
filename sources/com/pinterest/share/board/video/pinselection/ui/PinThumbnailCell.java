...
public final class PinThumbnailCell extends ConstraintLayout {
    ...
    public static final /* synthetic */ int f51839b = 0;

    /* renamed from: a, reason: collision with root package name */
    public final WebImageView f51840a;
    ...
    public PinThumbnailCell(@NotNull Context context, AttributeSet attributeSet, int i13) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        View.inflate(context, d.item_pin_preview_thumbnail, this);
        setBackground(c.f0(this, b.pin_thumbnail_shape, null, null, 6));
        setClipToOutline(true);
        int W = c.W(this, a.pin_thumbnail_size);
        setLayoutParams(new ConstraintLayout.LayoutParams(W, W));
        View findViewById = findViewById(o52.c.thumbnail_image);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(...)");
        this.f51840a = (WebImageView) findViewById;
        View findViewById2 = findViewById(o52.c.thumbnail_button_delete);
