...
@Keep
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u000b\b\u0087\u0081\u0002\u0018\u0000 \u00102\b\u0012\u0004\u0012\u00020\u00000\u00012\u00020\u0002:\u0001\u0011B\t\b\u0002¢\u0006\u0004\b\u000e\u0010\u000fJ\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J\u001f\u0010\n\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\bH\u0016¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\f\u001a\u00020\bH\u0016¢\u0006\u0004\b\f\u0010\rj\u0002\b\u0012¨\u0006\u0013"}, d2 = {"Lcom/pinterest/feature/search/results/goldstandard/viewpager/steps/GoldStandardStepsLocation;", "", "Lcom/pinterest/framework/screens/ScreenLocation;", "", "onScreenNavigation", "()V", "Landroid/os/Parcel;", "dest", "", "flags", "writeToParcel", "(Landroid/os/Parcel;I)V", "describeContents", "()I", "<init>", "(Ljava/lang/String;I)V", "Companion", "com/pinterest/feature/search/results/goldstandard/viewpager/steps/c", "GoldStandardSteps", "results_release"}, k = 1, mv = {1, 9, 0})
...
public abstract class GoldStandardStepsLocation implements ScreenLocation {
    ...
    @NotNull
    public static final Parcelable.Creator<GoldStandardStepsLocation> CREATOR;
    ...
    public static final GoldStandardStepsLocation GoldStandardSteps = new GoldStandardStepsLocation() { // from class: com.pinterest.feature.search.results.goldstandard.viewpager.steps.GoldStandardStepsLocation.GoldStandardSteps
        ...
        public final Class f47626a = a.class;
    ...
    static {
        GoldStandardStepsLocation[] $values = $values();
        $VALUES = $values;
        $ENTRIES = l0.b0($values);
        Companion = new c();
        CREATOR = new com.pinterest.feature.board.permissions.b(20);
    }

    public /* synthetic */ GoldStandardStepsLocation(String str, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i13);
    }
    ...
    public abstract /* synthetic */ Class getF47626a();
    ...
    private GoldStandardStepsLocation(String str, int i13) {
    }
}
