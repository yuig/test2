...
public abstract class k extends yk1.k implements af2.c {
    ...
    public boolean f44797f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f44798g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f44799h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f44800i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f44798g0 == null) {
            synchronized (this.f44799h0) {
                try {
                    if (this.f44798g0 == null) {
                        this.f44798g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f44798g0;
    }

    public final void Z7() {
        if (this.f44796e0 == null) {
            this.f44796e0 = new m(super.getContext(), this);
            this.f44797f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        el.a.x0(fVar, (k7) s8Var.D3.get());
        el.a.U1(fVar, (l) s8Var.f114476s.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f44797f0) {
            return null;
        }
        Z7();
        return this.f44796e0;
    }
