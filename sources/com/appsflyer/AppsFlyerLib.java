...
public abstract class AppsFlyerLib {
    public static AppsFlyerLib getInstance() {
        return AFb1tSDK.getCurrencyIso4217Code();
    }

    public abstract void addPushNotificationDeepLinkPath(String... strArr);

    public abstract void anonymizeUser(boolean z13);

    public abstract void appendParametersToDeepLinkingURL(String str, Map<String, String> map);

    public abstract void enableFacebookDeferredApplinks(boolean z13);

    public abstract void enableTCFDataCollection(boolean z13);
    ...
    public abstract void logAdRevenue(@NonNull AFAdRevenueData aFAdRevenueData, Map<String, Object> map);
    ...
    public abstract void logLocation(Context context, double d2, double d13);
    ...
    public abstract void setCollectAndroidID(boolean z13);

    public abstract void setCollectIMEI(boolean z13);

    @Deprecated
    public abstract void setCollectOaid(boolean z13);
    ...
    public abstract void setDebugLog(boolean z13);

    public abstract void setDisableAdvertisingIdentifiers(boolean z13);

    public abstract void setDisableNetworkData(boolean z13);

    public abstract void setExtension(String str);

    public abstract void setHost(String str, @NonNull String str2);

    public abstract void setImeiData(String str);

    public abstract void setIsUpdate(boolean z13);

    public abstract void setLogLevel(AFLogger.LogLevel logLevel);

    public abstract void setMinTimeBetweenSessions(int i13);
    ...
    public abstract void stop(boolean z13, Context context);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener, long j13);
    ...
    public abstract void validateAndLogInAppPurchase(@NonNull AFPurchaseDetails aFPurchaseDetails, Map<String, String> map, AppsFlyerInAppPurchaseValidationCallback appsFlyerInAppPurchaseValidationCallback);

    public abstract void waitForCustomerUserId(boolean z13);
}
