...
public enum g0 {
    ...
    private static final Map<Integer, g0> zzbo = new HashMap();
    private final int zzbq;

    static {
        for (g0 g0Var : values()) {
            zzbo.put(Integer.valueOf(g0Var.zzbq), g0Var);
        }
    }
    ...
    public static g0 zza(int i13) {
        return zzbo.get(Integer.valueOf(i13));
    }
