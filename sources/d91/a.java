...
public abstract class a extends jd1.d implements af2.c {

    /* renamed from: c1, reason: collision with root package name */
    public ye2.m f54041c1;

    /* renamed from: d1, reason: collision with root package name */
    public boolean f54042d1;

    /* renamed from: e1, reason: collision with root package name */
    public volatile ye2.h f54043e1;

    /* renamed from: f1, reason: collision with root package name */
    public final Object f54044f1 = new Object();

    /* renamed from: g1, reason: collision with root package name */
    public boolean f54045g1 = false;

    public final void A9() {
        if (this.f54041c1 == null) {
            this.f54041c1 = new ye2.m(super.getContext(), this);
            this.f54042d1 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void B9() {
        ...
        a02.e.H2();
        o.x(jVar);
        ig1.b.x0(jVar, (jd1.e) s8Var.f114465r2.get());
        o.y(jVar);
        o.C(jVar, (b4) s8Var.rc.get());
        o.A(jVar);
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f54042d1) {
            return null;
        }
        A9();
        return this.f54041c1;
    }
    ...
    public final ye2.h componentManager() {
        if (this.f54043e1 == null) {
            synchronized (this.f54044f1) {
                try {
                    if (this.f54043e1 == null) {
                        this.f54043e1 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f54043e1;
    }

    @Override // androidx.fragment.app.Fragment
    public final void onAttach(Activity activity) {
        super.onAttach(activity);
        ye2.m mVar = this.f54041c1;
