...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f99615v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f99616w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f99617x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f99618y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f99616w0 == null) {
            synchronized (this.f99617x0) {
                try {
                    if (this.f99616w0 == null) {
                        this.f99616w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f99616w0;
    }

    public final void S8() {
        if (this.f99614u0 == null) {
            this.f99614u0 = new m(super.getContext(), this);
            this.f99615v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        m0.i0(dVar, (uk1.e) oaVar.f113702ga.get());
        m0.r0(dVar, (x10.d) oaVar.f113997x5.get());
        m0.y0(dVar, (k) oaVar.f113921t1.get());
        m0.s0(dVar, s8Var.z6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f99615v0) {
            return null;
        }
        S8();
        return this.f99614u0;
    }
