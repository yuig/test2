...
public abstract class a<T extends jr.a> extends MvpViewPagerFragment<T> implements af2.c {
    ...
    public boolean f119315n0;

    /* renamed from: o0, reason: collision with root package name */
    public volatile ye2.h f119316o0;

    /* renamed from: p0, reason: collision with root package name */
    public final Object f119317p0 = new Object();

    /* renamed from: q0, reason: collision with root package name */
    public boolean f119318q0 = false;

    @Override // af2.c
    /* renamed from: g8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f119316o0 == null) {
            synchronized (this.f119317p0) {
                try {
                    if (this.f119316o0 == null) {
                        this.f119316o0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f119316o0;
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f119315n0) {
            return null;
        }
        h8();
        return this.f119314m0;
    }
    ...
    public final void h8() {
        if (this.f119314m0 == null) {
            this.f119314m0 = new m(super.getContext(), this);
            this.f119315n0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void i8() {
        ...
        v.I(hVar, (e8) s8Var.M4.get());
        v.U(hVar, (uk1.e) oaVar.f113702ga.get());
        v.J(hVar, (g8) s8Var.N4.get());
    }
