...
public abstract class a extends yk1.k implements af2.c {
    ...
    public ye2.m f140345e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f140346f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f140347g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f140348h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f140349i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f140347g0 == null) {
            synchronized (this.f140348h0) {
                try {
                    if (this.f140347g0 == null) {
                        this.f140347g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f140347g0;
    }

    public final void Z7() {
        if (this.f140345e0 == null) {
            this.f140345e0 = new ye2.m(super.getContext(), this);
            this.f140346f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        m0.e0(jVar, (h1) s8Var.G7.get());
        m0.L(jVar, (a11.d) oaVar.f113668ec.get());
        m0.l0(jVar, (uk1.e) oaVar.f113702ga.get());
        m0.Q(jVar, (rg0.s) oaVar.Q5.get());
        m0.n0(jVar, s8Var.j6());
        m0.m0(jVar, s8Var.i6());
        m0.J(jVar, s8Var.e5());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f140346f0) {
            return null;
        }
        Z7();
        return this.f140345e0;
    }
