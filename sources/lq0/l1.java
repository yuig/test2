...
public abstract class l1 extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f84354e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f84355f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f84356g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f84357h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f84358i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f84356g0 == null) {
            synchronized (this.f84357h0) {
                try {
                    if (this.f84356g0 == null) {
                        this.f84356g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
    ...
    public final void Z7() {
        if (this.f84354e0 == null) {
            this.f84354e0 = new ye2.m(super.getContext(), this);
            this.f84355f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        gh0.b.d0(eVar, (c7) s8Var.f114406n3.get());
        gh0.b.e0(eVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f84355f0) {
            return null;
        }
        Z7();
        return this.f84354e0;
    }
