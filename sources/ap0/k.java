...
public abstract class k extends yk1.k implements af2.c {
    ...
    public volatile ye2.h f20321g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f20322h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f20323i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f20321g0 == null) {
            synchronized (this.f20322h0) {
                try {
                    if (this.f20321g0 == null) {
                        this.f20321g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
    ...
    public final void Z7() {
        if (this.f20319e0 == null) {
            this.f20319e0 = new m(super.getContext(), this);
            this.f20320f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        m2.r1(iVar, (uk1.e) oaVar.f113702ga.get());
        m2.m1(iVar, (nu1.a) s8Var.f114462r.get());
        m2.t1(iVar, oa.U1(oaVar));
        m2.n1(iVar, (mo1.d) oaVar.D5.get());
        m2.h1(iVar, (lu1.b) oaVar.f113961v5.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f20320f0) {
            return null;
        }
        Z7();
