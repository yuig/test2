...
public abstract class a extends k implements af2.c {
    ...
    public boolean f85758f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile h f85759g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f85760h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f85761i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f85759g0 == null) {
            synchronized (this.f85760h0) {
                try {
                    if (this.f85759g0 == null) {
                        this.f85759g0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f85759g0;
    }

    public final void Z7() {
        if (this.f85757e0 == null) {
            this.f85757e0 = new m(super.getContext(), this);
            this.f85758f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        m0.g0(eVar, (uk1.e) oaVar.f113702ga.get());
        m0.a0(eVar, (i2) oaVar.F3.get());
        m0.x0(eVar, (i92.k) oaVar.f113921t1.get());
        m0.K(eVar, (x0) oaVar.f113765k3.get());
        m0.o0(eVar, s8Var.k6());
        m0.Y(eVar, (b0) oaVar.R8.get());
        m0.H(eVar, s8Var.e5());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f85758f0) {
            return null;
        }
        Z7();
        return this.f85757e0;
    }
