...
public abstract class b extends yk1.k implements af2.c {
    ...
    public ye2.m f68703e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f68704f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f68705g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f68706h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f68707i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f68705g0 == null) {
            synchronized (this.f68706h0) {
                try {
                    if (this.f68705g0 == null) {
                        this.f68705g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f68705g0;
    }

    public final void Z7() {
        if (this.f68703e0 == null) {
            this.f68703e0 = new ye2.m(super.getContext(), this);
            this.f68704f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        t.n0(iVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f68704f0) {
            return null;
        }
        Z7();
        return this.f68703e0;
    }
