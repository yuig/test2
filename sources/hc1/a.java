...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f68698u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f68699v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f68700w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f68701x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f68702y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f68700w0 == null) {
            synchronized (this.f68701x0) {
                try {
                    if (this.f68700w0 == null) {
                        this.f68700w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f68700w0;
    }

    public final void S8() {
        if (this.f68698u0 == null) {
            this.f68698u0 = new ye2.m(super.getContext(), this);
            this.f68699v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        pe.i.q0(eVar, (f0) oaVar.f113747j2.get());
        pe.i.u0(eVar, (q3) s8Var.jb.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f68699v0) {
            return null;
        }
        S8();
        return this.f68698u0;
    }
