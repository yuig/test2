...
public abstract class g<D extends a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f123198u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f123199v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f123200w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f123201x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f123202y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f123200w0 == null) {
            synchronized (this.f123201x0) {
                try {
                    if (this.f123200w0 == null) {
                        this.f123200w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f123200w0;
    }

    public final void S8() {
        if (this.f123198u0 == null) {
            this.f123198u0 = new ye2.m(super.getContext(), this);
            this.f123199v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        g0.O(lVar, (uk1.e) oaVar.f113702ga.get());
        g0.I(lVar);
        g0.J(lVar, (lb0.q) oaVar.O0.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f123199v0) {
            return null;
        }
        S8();
        return this.f123198u0;
    }
