...
public abstract class h<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f123203u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f123204v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f123205w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f123206x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f123207y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f123205w0 == null) {
            synchronized (this.f123206x0) {
                try {
                    if (this.f123205w0 == null) {
                        this.f123205w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f123205w0;
    }

    public final void S8() {
        if (this.f123203u0 == null) {
            this.f123203u0 = new ye2.m(super.getContext(), this);
            this.f123204v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        qVar.f91298w = (w) oaVar.f113885r0.get();
        ...
        kg.o.B(qVar, (uk1.e) oaVar.f113702ga.get());
        kg.o.w(qVar, s8Var.e6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f123204v0) {
            return null;
        }
        S8();
        return this.f123203u0;
    }
