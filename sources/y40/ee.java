...
public final class ee implements pc.a {

    /* renamed from: a, reason: collision with root package name */
    public static final ee f137029a = new ee();

    /* renamed from: b, reason: collision with root package name */
    public static final List f137030b = kotlin.collections.f0.j("__typename", "width", "height");

    @Override // pc.a
    public final void d(tc.g writer, pc.v customScalarAdapters, Object obj) {
        x40.jf value = (x40.jf) obj;
    ...
    public final Object f(tc.f reader, pc.v customScalarAdapters) {
        ...
        while (true) {
            ...
            if (V1 == 0) {
                ...
                if (V1 != 2) {
                    Intrinsics.f(str);
                    return new x40.jf(num, num2, str);
                }
