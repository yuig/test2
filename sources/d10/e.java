...
public final class e extends j implements Function2 {
    ...
    public /* synthetic */ Object f53604r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ g f53605s;
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        e eVar = new e(this.f53605s, cVar);
        eVar.f53604r = obj;
        return eVar;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((e) create((pc.h) obj, (bl2.c) obj2)).invokeSuspend(Unit.f80348a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ue.c.H(obj);
        pc.h hVar2 = (pc.h) this.f53604r;
        List list = hVar2.f99564d;
        g gVar2 = this.f53605s;
        if (list == null || !(!list.isEmpty())) {
            hVar = hVar2;
            gVar = gVar2;
        } else {
            o0 o0Var = hVar2.f99562b;
            String operationName = o0Var.name();
            String operationId = o0Var.a();
            String a13 = o0Var.a();
            gVar2.getClass();
            ArrayList arrayList = new ArrayList();
            arrayList.add(a.a.m("[", a13, ":", operationName, "]"));
            for (Object obj2 : list) {
                b0 b0Var = obj2 instanceof b0 ? (b0) obj2 : null;
                if (b0Var != null) {
                    arrayList.add(b0Var.f99516b + ": " + b0Var.f99515a);
                }
            }
            String errorMessage = CollectionsKt.Z(arrayList, ", ", null, null, 0, null, null, 62);
            ...
            if (StringsKt.E(errorMessage, "INTERNAL GRAPHQL ERROR", false)) {
                ...
                gVar = gVar2;
                gVar.f53613c.a(new ErrorLog(new ErrorLog.ErrorLogPayload(errorMessage, null, operationId, operationName, pVar.name()), null, null, 4, null));
            }
        }
        kotlin.jvm.internal.j.z(dl2.b.b(gVar.f53612b.f92750a), null, null, new d(gVar, hVar, null), 3);
        return Unit.f80348a;
    }
}
