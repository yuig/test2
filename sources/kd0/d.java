...
public abstract class d<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f79225v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f79226w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f79227x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f79228y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f79226w0 == null) {
            synchronized (this.f79227x0) {
                try {
                    if (this.f79226w0 == null) {
                        this.f79226w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f79226w0;
    }

    public final void S8() {
        if (this.f79224u0 == null) {
            this.f79224u0 = new m(super.getContext(), this);
            this.f79225v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        el.a.y0(bVar, s8Var.t5());
        el.a.U0(bVar, (nu1.a) s8Var.f114462r.get());
        el.a.V1(bVar, (l) s8Var.f114476s.get());
        el.a.w0(bVar, (l7) s8Var.F3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f79225v0) {
            return null;
        }
        S8();
        return this.f79224u0;
    }
