...
public abstract class b extends mm1.l {
    ...
    public ye2.m f137780d0;

    /* renamed from: e0, reason: collision with root package name */
    public boolean f137781e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f137782f0 = false;
    ...
    public final void X7() {
        ...
        this.f137782f0 = true;
        x0 x0Var = (x0) this;
        x8 x8Var = (x8) ((y0) generatedComponent());
        oa oaVar = x8Var.f114707a;
        x0Var.f91283h = oaVar.Ec;
        x0Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        x0Var.f91296u = (d1) oaVar.f113730i2.get();
    ...
    public final void c8() {
        if (this.f137780d0 == null) {
            this.f137780d0 = new ye2.m(super.getContext(), this);
            this.f137781e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f137781e0) {
            return null;
        }
        c8();
        return this.f137780d0;
    }
