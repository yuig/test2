...
public final class k extends dl2.j implements Function2 {
    ...
    public final /* synthetic */ m f141380s;
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        return new k(this.f141380s, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i13 = this.f141379r;
        if (i13 == 0) {
            ue.c.H(obj);
            m mVar = this.f141380s;
            androidx.lifecycle.z viewLifecycleOwner = mVar.getViewLifecycleOwner();
