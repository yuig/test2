...
public abstract class b extends yk1.k implements af2.c {
    ...
    public boolean f117125f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f117126g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f117127h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f117128i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f117126g0 == null) {
            synchronized (this.f117127h0) {
                try {
                    if (this.f117126g0 == null) {
                        this.f117126g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f117126g0;
    }

    public final void Z7() {
        if (this.f117124e0 == null) {
            this.f117124e0 = new m(super.getContext(), this);
            this.f117125f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        g0.L(jVar, new u());
        g0.P(jVar, (i92.k) oaVar.f113921t1.get());
        g0.N(jVar, (uk1.e) oaVar.f113702ga.get());
        g0.C(jVar, new o3((z0) s8Var.f114255d.D0.get()));
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f117125f0) {
            return null;
        }
        Z7();
        return this.f117124e0;
    }
