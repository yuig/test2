...
public abstract class a extends yk1.k implements af2.c {
    ...
    public boolean f117120f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f117121g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f117122h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f117123i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f117121g0 == null) {
            synchronized (this.f117122h0) {
                try {
                    if (this.f117121g0 == null) {
                        this.f117121g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f117121g0;
    }

    public final void Z7() {
        if (this.f117119e0 == null) {
            this.f117119e0 = new m(super.getContext(), this);
            this.f117120f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        kh2.w.b0(hVar, new z(29));
        kh2.w.e0(hVar, (i92.k) oaVar.f113921t1.get());
        kh2.w.Y(hVar, new dv0.q((b60.b) s8Var.f114255d.f113850p0.get()));
        kh2.w.U(hVar);
        kh2.w.X(hVar, (x10.a) oaVar.f113830nf.get());
        kh2.w.V(hVar);
        kh2.w.d0(hVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f117120f0) {
            return null;
        }
        Z7();
        return this.f117119e0;
    }
