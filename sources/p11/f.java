...
public abstract class f extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f98647e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f98648f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f98649g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f98650h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f98651i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f98649g0 == null) {
            synchronized (this.f98650h0) {
                try {
                    if (this.f98649g0 == null) {
                        this.f98649g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f98649g0;
    }

    public final void Z7() {
        if (this.f98647e0 == null) {
            this.f98647e0 = new ye2.m(super.getContext(), this);
            this.f98648f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        m0.M(lVar, (q1) s8Var.f114263d8.get());
        m0.h0(lVar, (uk1.e) oaVar.f113702ga.get());
        m0.Z(lVar, (r1) s8Var.f114278e8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f98648f0) {
            return null;
        }
        Z7();
        return this.f98647e0;
    }
