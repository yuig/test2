...
public abstract class a<D extends yq0.a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f120591u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f120592v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f120593w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f120594x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f120595y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f120593w0 == null) {
            synchronized (this.f120594x0) {
                try {
                    if (this.f120593w0 == null) {
                        this.f120593w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f120593w0;
    }

    public final void S8() {
        if (this.f120591u0 == null) {
            this.f120591u0 = new ye2.m(super.getContext(), this);
            this.f120592v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        kg.p.J(iVar, (a11.d) oaVar.f113668ec.get());
        kg.p.L(iVar, (uk1.e) oaVar.f113702ga.get());
        kg.p.I(iVar, (a12.d) oaVar.Xd.get());
        kg.p.K(iVar, (i2) oaVar.F3.get());
        kg.p.M(iVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f120592v0) {
            return null;
        }
        S8();
        return this.f120591u0;
    }
