...
public abstract class a extends l {
    ...
    public final void c8() {
        if (this.f2084d0 == null) {
            this.f2084d0 = new m(super.getContext(), this);
            this.f2085e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f2085e0) {
            return null;
        }
        c8();
        return this.f2084d0;
