...
public abstract class e extends k implements af2.c {
    ...
    public boolean f142952f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f142953g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f142954h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f142955i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f142953g0 == null) {
            synchronized (this.f142954h0) {
                try {
                    if (this.f142953g0 == null) {
                        this.f142953g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f142953g0;
    }

    public final void Z7() {
        if (this.f142951e0 == null) {
            this.f142951e0 = new m(super.getContext(), this);
            this.f142952f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        r.w0(cVar, (z0) s8Var.f114455q7.get());
        r.O0(cVar, (uk1.e) oaVar.f113702ga.get());
        r.k0(cVar);
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f142952f0) {
            return null;
        }
        Z7();
        return this.f142951e0;
    }
