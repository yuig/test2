...
public abstract class w extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f143251a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f143252b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f143251a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        d0Var.f91285j = (f0) oaVar.f113747j2.get();
        ...
        d0Var.f143181k0 = (vy.m) oaVar.M1.get();
        d0Var.f143182l0 = (i92.k) oaVar.f113921t1.get();
        d0Var.f143183m0 = oaVar.a2();
        d0Var.f143184n0 = new w2((z0) x8Var.f114707a.D0.get());
    }
