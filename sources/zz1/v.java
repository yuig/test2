...
public abstract class v extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f143249a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f143250b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f143249a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        zVar.f143258c0 = (i92.k) oaVar.f113921t1.get();
        zVar.f143259d0 = oaVar.a2();
        zVar.f143260e0 = (v8) x8Var.f114709c.get();
    }
