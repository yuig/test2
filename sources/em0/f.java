...
public abstract class f<D extends a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public m f59589u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f59590v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f59591w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f59592x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f59593y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f59591w0 == null) {
            synchronized (this.f59592x0) {
                try {
                    if (this.f59591w0 == null) {
                        this.f59591w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f59591w0;
    }

    public final void S8() {
        if (this.f59589u0 == null) {
            this.f59589u0 = new m(super.getContext(), this);
            this.f59590v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        f0.h.T(dVar, (y) oaVar.f113660e4.get());
        f0.h.V(dVar, (x0) oaVar.f113765k3.get());
        f0.h.X(dVar, (uk1.e) oaVar.f113702ga.get());
        f0.h.Y(dVar, new cm0.b((e12.c) s8Var.f114255d.E3.get()));
        f0.h.U(dVar, s8Var.e5());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f59590v0) {
            return null;
        }
        S8();
        return this.f59589u0;
    }
