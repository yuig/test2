...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f129099v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f129100w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f129101x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f129102y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f129100w0 == null) {
            synchronized (this.f129101x0) {
                try {
                    if (this.f129100w0 == null) {
                        this.f129100w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f129100w0;
    }

    public final void S8() {
        if (this.f129098u0 == null) {
            this.f129098u0 = new m(super.getContext(), this);
            this.f129099v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        ph.a.p0(eVar, (uk1.e) oaVar.f113702ga.get());
        ph.a.h0(eVar, (cr1.a) oaVar.A2.get());
        ph.a.t0(eVar, (k) oaVar.f113921t1.get());
        ph.a.m0(eVar, (t3) s8Var.f114578yb.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f129099v0) {
            return null;
        }
        S8();
        return this.f129098u0;
    }
