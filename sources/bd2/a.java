...
public abstract class a extends com.pinterest.widget.configuration.a implements af2.c {
    public m Y;
    public boolean Z;

    /* renamed from: a0, reason: collision with root package name */
    public volatile h f22724a0;

    /* renamed from: b0, reason: collision with root package name */
    public final Object f22725b0 = new Object();

    /* renamed from: c0, reason: collision with root package name */
    public boolean f22726c0 = false;

    @Override // af2.c
    /* renamed from: W7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f22724a0 == null) {
            synchronized (this.f22725b0) {
                try {
                    if (this.f22724a0 == null) {
                        this.f22724a0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f22724a0;
    }

    public final void X7() {
        if (this.Y == null) {
            this.Y = new m(super.getContext(), this);
            this.Z = ue.c.x(super.getContext());
        }
    }
    ...
    public final void Y7() {
        ...
        oe.f.Q0(cVar, (com.pinterest.widget.configuration.h) oaVar.T8.get());
    }
