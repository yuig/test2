...
public abstract class y extends m implements af2.c {

    /* renamed from: g0, reason: collision with root package name */
    public ye2.m f99492g0;

    /* renamed from: h0, reason: collision with root package name */
    public boolean f99493h0;

    /* renamed from: i0, reason: collision with root package name */
    public volatile ye2.h f99494i0;

    /* renamed from: j0, reason: collision with root package name */
    public final Object f99495j0 = new Object();

    /* renamed from: k0, reason: collision with root package name */
    public boolean f99496k0 = false;

    @Override // af2.c
    /* renamed from: X7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f99494i0 == null) {
            synchronized (this.f99495j0) {
                try {
                    if (this.f99494i0 == null) {
                        this.f99494i0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f99494i0;
    }

    public final void Y7() {
        if (this.f99492g0 == null) {
            this.f99492g0 = new ye2.m(super.getContext(), this);
            this.f99493h0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f99493h0) {
            return null;
        }
        Y7();
        return this.f99492g0;
    }
