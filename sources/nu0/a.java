...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f92313v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f92314w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f92315x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f92316y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f92314w0 == null) {
            synchronized (this.f92315x0) {
                try {
                    if (this.f92314w0 == null) {
                        this.f92314w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f92314w0;
    }

    public final void S8() {
        if (this.f92312u0 == null) {
            this.f92312u0 = new m(super.getContext(), this);
            this.f92313v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        n.E(iVar, (de0.d) oaVar.S7.get());
        n.L(iVar, (b8) s8Var.G4.get());
        n.S(iVar, (i92.k) oaVar.f113921t1.get());
        n.F(iVar, (zf0.f) oaVar.f113723hd.get());
        n.M(iVar, (ag1.h) oaVar.K8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f92313v0) {
            return null;
        }
        S8();
        return this.f92312u0;
    }
