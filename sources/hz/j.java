...
public abstract class j extends yk1.k implements af2.c {
    ...
    public volatile ye2.h f70625g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f70626h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f70627i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f70625g0 == null) {
            synchronized (this.f70626h0) {
                try {
                    if (this.f70625g0 == null) {
                        this.f70625g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f70625g0;
    }

    public final void Z7() {
        if (this.f70623e0 == null) {
            this.f70623e0 = new m(super.getContext(), this);
            this.f70624f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f70624f0) {
            return null;
        }
        Z7();
