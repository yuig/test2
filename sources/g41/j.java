...
public abstract class j<D extends a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f63517u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f63518v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f63519w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f63520x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f63521y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f63519w0 == null) {
            synchronized (this.f63520x0) {
                try {
                    if (this.f63519w0 == null) {
                        this.f63519w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f63519w0;
    }

    public final void S8() {
        if (this.f63517u0 == null) {
            this.f63517u0 = new ye2.m(super.getContext(), this);
            this.f63518v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        oe.f.A0(mVar, (uk1.e) oaVar.f113702ga.get());
        oe.f.D0(mVar, (c2) s8Var.D8.get());
        oe.f.L0(mVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f63518v0) {
            return null;
        }
        S8();
        return this.f63517u0;
    }
