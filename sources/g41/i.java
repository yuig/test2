...
public abstract class i<D extends a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f63512u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f63513v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f63514w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f63515x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f63516y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f63514w0 == null) {
            synchronized (this.f63515x0) {
                try {
                    if (this.f63514w0 == null) {
                        this.f63514w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f63514w0;
    }

    public final void S8() {
        if (this.f63512u0 == null) {
            this.f63512u0 = new ye2.m(super.getContext(), this);
            this.f63513v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        c0.d.z1(eVar, (uk1.e) oaVar.f113702ga.get());
        c0.d.V0(eVar, (b2) s8Var.f114590z8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f63513v0) {
            return null;
        }
        S8();
        return this.f63512u0;
    }
