...
public abstract class k {
    ...
    public static final String b(Context context) {
        ...
        try {
            ...
            Object newProxyInstance = Proxy.newProxyInstance(k.class.getClassLoader(), new Class[]{cls2}, new j(obj, j0Var, reentrantLock, newCondition));
            ...
            method.invoke(context.getPackageManager(), context.getPackageName(), Boolean.FALSE, obj, CollectionsKt.H0(H0), newProxyInstance);
            newCondition.await();
            String str2 = (String) j0Var.f80434a;
