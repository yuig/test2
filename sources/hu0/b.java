...
public abstract class b extends fu0.d implements af2.c {

    /* renamed from: w0, reason: collision with root package name */
    public m f70395w0;

    /* renamed from: x0, reason: collision with root package name */
    public boolean f70396x0;

    /* renamed from: y0, reason: collision with root package name */
    public volatile h f70397y0;

    /* renamed from: z0, reason: collision with root package name */
    public final Object f70398z0 = new Object();
    public boolean A0 = false;

    @Override // af2.c
    /* renamed from: a8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f70397y0 == null) {
            synchronized (this.f70398z0) {
                try {
                    if (this.f70397y0 == null) {
                        this.f70397y0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f70397y0;
    }

    public final void b8() {
        if (this.f70395w0 == null) {
            this.f70395w0 = new m(super.getContext(), this);
            this.f70396x0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void c8() {
        ...
        dn.c.T(eVar, (uk1.e) oaVar.f113702ga.get());
        el.a.S0(eVar, (a8) s8Var.E4.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f70396x0) {
            return null;
        }
        b8();
        return this.f70395w0;
    }
