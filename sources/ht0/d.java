...
public abstract class d<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f70106u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f70107v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f70108w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f70109x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f70110y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f70108w0 == null) {
            synchronized (this.f70109x0) {
                try {
                    if (this.f70108w0 == null) {
                        this.f70108w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f70108w0;
    }

    public final void S8() {
        if (this.f70106u0 == null) {
            this.f70106u0 = new ye2.m(super.getContext(), this);
            this.f70107v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        rVar.f91298w = (w) oaVar.f113885r0.get();
        ...
        k3.c1(rVar, (uk1.e) oaVar.f113702ga.get());
        k3.P0(rVar, (g0) oaVar.f113590a4.get());
        k3.I0(rVar, s8Var.G5());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f70107v0) {
            return null;
        }
        S8();
        return this.f70106u0;
    }
