...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f70091u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f70092v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f70093w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f70094x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f70095y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f70093w0 == null) {
            synchronized (this.f70094x0) {
                try {
                    if (this.f70093w0 == null) {
                        this.f70093w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f70093w0;
    }

    public final void S8() {
        if (this.f70091u0 == null) {
            this.f70091u0 = new ye2.m(super.getContext(), this);
            this.f70092v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        p2.J0(gVar, (uk1.e) oaVar.f113702ga.get());
        p2.w0(gVar, s8Var.H5());
        p2.L0(gVar, (b60.b) oaVar.f113850p0.get());
        p2.t0(gVar, s8Var.r6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f70092v0) {
            return null;
        }
        S8();
        return this.f70091u0;
    }
