...
public abstract class c<T extends jr.a> extends MvpViewPagerFragment<T> implements af2.c {

    /* renamed from: m0, reason: collision with root package name */
    public ye2.m f70101m0;

    /* renamed from: n0, reason: collision with root package name */
    public boolean f70102n0;

    /* renamed from: o0, reason: collision with root package name */
    public volatile ye2.h f70103o0;

    /* renamed from: p0, reason: collision with root package name */
    public final Object f70104p0 = new Object();

    /* renamed from: q0, reason: collision with root package name */
    public boolean f70105q0 = false;

    @Override // af2.c
    /* renamed from: g8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f70103o0 == null) {
            synchronized (this.f70104p0) {
                try {
                    if (this.f70103o0 == null) {
                        this.f70103o0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f70103o0;
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f70102n0) {
            return null;
        }
        h8();
        return this.f70101m0;
    }
    ...
    public final void h8() {
        if (this.f70101m0 == null) {
            this.f70101m0 = new ye2.m(super.getContext(), this);
            this.f70102n0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void i8() {
        ...
        g3.B0(mVar, s8Var.f114467r4);
        g3.t1(mVar, (uk1.e) oaVar.f113702ga.get());
        g3.z1(mVar, (w7) s8Var.f114481s4.get());
        g3.T1(mVar, oaVar.e3());
    }
