...
public final class p implements qn2.b {

    /* renamed from: a, reason: collision with root package name */
    public final Map f23594a;

    /* renamed from: b, reason: collision with root package name */
    public final qn2.c f23595b;

    public p(HashMap hashMap, qn2.c equalityAxioms, qn2.i kotlinTypeRefiner) {
        qn2.e kotlinTypePreparator = qn2.e.f104497a;
        Intrinsics.checkNotNullParameter(equalityAxioms, "equalityAxioms");
        Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
        Intrinsics.checkNotNullParameter(kotlinTypePreparator, "kotlinTypePreparator");
        this.f23594a = hashMap;
        this.f23595b = equalityAxioms;
    }
    ...
    @Override // sn2.k
    public final qn2.a G(sn2.g gVar) {
    ...
    @Override // sn2.k
    public final qn2.l M(sn2.c cVar) {
        return a0.t1(cVar);
    }
    ...
    @Override // sn2.k
    public final boolean T(sn2.i c13, sn2.i c23) {
        ...
        if (c23 instanceof b1) {
            return a0.d(c13, c23) || o0((b1) c13, (b1) c23);
        }
        throw new IllegalArgumentException("Failed requirement.".toString());
    }
    ...
    public final boolean o0(b1 b1Var, b1 b1Var2) {
        if (this.f23595b.a(b1Var, b1Var2)) {
            return true;
        }
        Map map = this.f23594a;
        if (map == null) {
            return false;
        }
