...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f110232v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f110233w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f110234x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f110235y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f110233w0 == null) {
            synchronized (this.f110234x0) {
                try {
                    if (this.f110233w0 == null) {
                        this.f110233w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f110233w0;
    }

    public final void S8() {
        if (this.f110231u0 == null) {
            this.f110231u0 = new m(super.getContext(), this);
            this.f110232v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        g3.H1(cVar, (uk1.e) oaVar.f113702ga.get());
        g3.B1(cVar, (m1) s8Var.V7.get());
        g3.O1(cVar, (e01.a) s8Var.K7.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f110232v0) {
            return null;
        }
        S8();
        return this.f110231u0;
    }
