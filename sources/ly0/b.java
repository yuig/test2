...
public abstract class b extends k implements af2.c {
    ...
    public boolean f85111f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f85112g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f85113h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f85114i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f85112g0 == null) {
            synchronized (this.f85113h0) {
                try {
                    if (this.f85112g0 == null) {
                        this.f85112g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f85112g0;
    }

    public final void Z7() {
        if (this.f85110e0 == null) {
            this.f85110e0 = new m(super.getContext(), this);
            this.f85111f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        b0.E0(dVar, (oc.c) oaVar.f113907s5.get());
        b0.d1(dVar, (r0) s8Var.f114233b7.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f85111f0) {
            return null;
        }
        Z7();
        return this.f85110e0;
    }
