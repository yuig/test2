...
public abstract class a extends nl1.d implements af2.c {
    ...
    public final Object f128459a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f128460b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f128459a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        g0.E(iVar, (z82.b) oaVar.f113681f7.get());
        g0.y(iVar, (z70.m) s8Var.f114387m.get());
        g0.z(iVar, (pb0.a) oaVar.f113834o1.get());
        g0.x(iVar, (m60.e) oaVar.f113920t0.get());
    }
