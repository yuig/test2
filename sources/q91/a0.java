...
public abstract class a0 extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f103053a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f103054b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f103053a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        kg.t.G0(o0Var, (i92.k) oaVar.f113921t1.get());
        kg.t.W(o0Var, (mr1.a) oaVar.B6.get());
        kg.t.j0(o0Var, (tb) s8Var.f114498t6.get());
    }
