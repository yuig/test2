...
public abstract class z extends mm1.l {
    ...
    public ye2.m f103188d0;

    /* renamed from: e0, reason: collision with root package name */
    public boolean f103189e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f103190f0 = false;
    ...
    public final void c8() {
        if (this.f103188d0 == null) {
            this.f103188d0 = new ye2.m(super.getContext(), this);
            this.f103189e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f103189e0) {
            return null;
        }
        c8();
        return this.f103188d0;
    }
