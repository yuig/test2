...
public abstract class f0 extends nl1.d implements af2.c {
    ...
    public final Object f103096a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f103097b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f103096a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        d1Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        kh2.b0.B0(d1Var, (mr1.a) oaVar.B6.get());
        kh2.b0.s1(d1Var, (i92.k) oaVar.f113921t1.get());
    }
