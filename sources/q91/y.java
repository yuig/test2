...
public abstract class y<D extends yq0.a0> extends yq0.b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f103182u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f103183v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f103184w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f103185x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f103186y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f103184w0 == null) {
            synchronized (this.f103185x0) {
                try {
                    if (this.f103184w0 == null) {
                        this.f103184w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f103184w0;
    }

    public final void S8() {
        if (this.f103182u0 == null) {
            this.f103182u0 = new ye2.m(super.getContext(), this);
            this.f103183v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public void T8() {
        ...
        ph.a.s0(uVar, (i92.k) oaVar.f113921t1.get());
        ph.a.o0(uVar, (uk1.e) oaVar.f113702ga.get());
        ph.a.i0(uVar, (lb2.n) oaVar.B6.get());
        ph.a.l0(uVar);
        ph.a.u0(uVar, (k22.m) oaVar.Y4.get());
        ph.a.k0(uVar, s8Var.z6());
    }
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f103183v0) {
            return null;
        }
        S8();
        return this.f103182u0;
    }
