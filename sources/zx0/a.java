...
public abstract class a<T extends jr.a> extends MvpViewPagerFragment<T> implements af2.c {
    ...
    public boolean f143005n0;

    /* renamed from: o0, reason: collision with root package name */
    public volatile h f143006o0;

    /* renamed from: p0, reason: collision with root package name */
    public final Object f143007p0 = new Object();

    /* renamed from: q0, reason: collision with root package name */
    public boolean f143008q0 = false;

    @Override // af2.c
    /* renamed from: g8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f143006o0 == null) {
            synchronized (this.f143007p0) {
                try {
                    if (this.f143006o0 == null) {
                        this.f143006o0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f143006o0;
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f143005n0) {
            return null;
        }
        h8();
        return this.f143004m0;
    }
    ...
    public final void h8() {
        if (this.f143004m0 == null) {
            this.f143004m0 = new m(super.getContext(), this);
            this.f143005n0 = ue.c.x(super.getContext());
        }
    }
