...
public abstract class o extends yk1.k implements af2.c {
    ...
    public ye2.m f58526e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f58527f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f58528g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f58529h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f58530i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f58528g0 == null) {
            synchronized (this.f58529h0) {
                try {
                    if (this.f58528g0 == null) {
                        this.f58528g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f58528g0;
    }

    public final void Z7() {
        if (this.f58526e0 == null) {
            this.f58526e0 = new ye2.m(super.getContext(), this);
            this.f58527f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        k3.X0(cVar, (h7) s8Var.f114555x3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f58527f0) {
            return null;
        }
        Z7();
        return this.f58526e0;
    }
