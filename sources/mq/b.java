...
public abstract class b extends nl1.d implements af2.c {
    ...
    public final Object f87952a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f87953b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f87952a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        this.f87953b0 = true;
        h0 h0Var = (h0) this;
        x8 x8Var = (x8) ((i0) generatedComponent());
        oa oaVar = x8Var.f114707a;
        h0Var.f91283h = oaVar.Ec;
        h0Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        h0Var.f91296u = (d1) oaVar.f113730i2.get();
        ...
        kh2.n.J(h0Var, (il1.a) s8Var.f114581z.get());
        kh2.n.G(h0Var, s8Var.j5());
    }
