...
public final class b extends dl2.j implements Function2 {
    ...
    public final /* synthetic */ p0 f97753r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ List f97754s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(p0 p0Var, List list, bl2.c cVar) {
        super(2, cVar);
        this.f97753r = p0Var;
        this.f97754s = list;
    }
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        return new b(this.f97753r, this.f97754s, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        List verificationConfigs = this.f97754s;
        ...
        try {
            ...
            android.support.v4.media.a e13 = android.support.v4.media.a.e(partner, serviceContent, arrayList);
            fn.b bVar2 = fn.b.VIDEO;
            fn.d dVar = fn.d.BEGIN_TO_RENDER;
            fn.f fVar = fn.f.NATIVE;
            fn.i b14 = fn.i.b(e2.g0.b(bVar2, dVar, fVar, fVar), e13);
            return new ww.e(new ww.c(b14, com.iab.omid.library.pinterest.adsession.media.b.e(b14), com.iab.omid.library.pinterest.adsession.media.b.f(b14)));
        } catch (Exception e14) {
            return new ww.d(e14);
        }
    }
