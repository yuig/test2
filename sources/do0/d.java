...
public abstract class d<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f55657v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f55658w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f55659x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f55660y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f55658w0 == null) {
            synchronized (this.f55659x0) {
                try {
                    if (this.f55658w0 == null) {
                        this.f55658w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f55658w0;
    }

    public final void S8() {
        if (this.f55656u0 == null) {
            this.f55656u0 = new m(super.getContext(), this);
            this.f55657v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        dl2.b.I(f0Var);
        kh2.d.X(bVar, f0Var);
        kh2.d.R(bVar, (u5) s8Var.f114478s1.get());
        kh2.d.r0(bVar, (uk1.e) oaVar.f113702ga.get());
        kh2.d.P(bVar, (yk1.a) s8Var.B.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f55657v0) {
            return null;
        }
        S8();
        return this.f55656u0;
    }
