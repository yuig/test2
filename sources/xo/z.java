...
public final class z implements m60.t {
    ...
    public final /* synthetic */ i f135573a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ m60.w f135574b;

    public z(i iVar, m60.w wVar) {
        this.f135573a = iVar;
        this.f135574b = wVar;
    }
    ...
    public final void onEventMainThread(g91.b bVar) {
        ...
        hk2.u j03 = x0Var.j0(list2, true, uid);
        uj2.a0 a0Var = tk2.e.f118017c;
        fk2.c l13 = j03.l(a0Var);
        Intrinsics.checkNotNullExpressionValue(l13, "subscribeOn(...)");
        String uid2 = v7Var.getUid();
        Intrinsics.checkNotNullExpressionValue(uid2, "getUid(...)");
        fk2.c l14 = x0Var.j0(list, false, uid2).l(a0Var);
        Intrinsics.checkNotNullExpressionValue(l14, "subscribeOn(...)");
        iVar.f135520j.a(new fk2.r(new uj2.f[]{l13, l14}, 1).h(wj2.c.a()).i(new d(list2, list, iVar.f135514d, iVar.f135512b, 1), new a(iVar, i13)));
    }

    @sp2.k(threadMode = ThreadMode.MAIN)
    public final void onEventMainThread(a0 a0Var) {
        i iVar = this.f135573a;
        iVar.f135518h.n(iVar.f135512b, 5, this.f135574b, false, 1);
