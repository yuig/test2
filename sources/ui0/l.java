...
public abstract class l<D extends a0> extends b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public m f122285u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f122286v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f122287w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f122288x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f122289y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f122287w0 == null) {
            synchronized (this.f122288x0) {
                try {
                    if (this.f122287w0 == null) {
                        this.f122287w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f122287w0;
    }

    public final void S8() {
        if (this.f122285u0 == null) {
            this.f122285u0 = new m(super.getContext(), this);
            this.f122286v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        v.t(eVar, (z1) s8Var.f114552x0.get());
        v.V(eVar, (uk1.e) oaVar.f113702ga.get());
        v.z(eVar, (hf0.c) oaVar.f113717h7.get());
        v.C(eVar, (s) oaVar.Q5.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f122286v0) {
            return null;
        }
        S8();
        return this.f122285u0;
    }
