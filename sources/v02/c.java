...
public abstract class c<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f123779u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f123780v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f123781w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f123782x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f123783y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f123781w0 == null) {
            synchronized (this.f123782x0) {
                try {
                    if (this.f123781w0 == null) {
                        this.f123781w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f123781w0;
    }

    public final void S8() {
        if (this.f123779u0 == null) {
            this.f123779u0 = new ye2.m(super.getContext(), this);
            this.f123780v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        pp2.a.x0(tVar, (y2) s8Var.f114501t9.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f123780v0) {
            return null;
        }
        S8();
        return this.f123779u0;
    }
