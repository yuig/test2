...
public abstract class a extends yk1.k implements af2.c {
    ...
    public ye2.m f123769e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f123770f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f123771g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f123772h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f123773i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f123771g0 == null) {
            synchronized (this.f123772h0) {
                try {
                    if (this.f123771g0 == null) {
                        this.f123771g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f123771g0;
    }

    public final void Z7() {
        if (this.f123769e0 == null) {
            this.f123769e0 = new ye2.m(super.getContext(), this);
            this.f123770f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        g3.M1(jVar, (u2) s8Var.f114412n9.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f123770f0) {
            return null;
        }
        Z7();
        return this.f123769e0;
    }
