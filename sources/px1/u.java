...
public abstract class u extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f101697e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f101698f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f101699g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f101700h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f101701i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f101699g0 == null) {
            synchronized (this.f101700h0) {
                try {
                    if (this.f101699g0 == null) {
                        this.f101699g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f101699g0;
    }

    public final void Z7() {
        if (this.f101697e0 == null) {
            this.f101697e0 = new ye2.m(super.getContext(), this);
            this.f101698f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        s0.q0(fVar, (uk1.e) oaVar.f113702ga.get());
        s0.Q(fVar, (e1) s8Var.f114574y7.get());
        s0.Z(fVar, (xw1.b) s8Var.f114322h7.get());
        s0.a0(fVar, (x0) s8Var.f114366k7.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f101698f0) {
            return null;
        }
        Z7();
        return this.f101697e0;
    }
