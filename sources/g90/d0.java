...
public abstract class d0 extends mm1.l {

    /* renamed from: d0, reason: collision with root package name */
    public ye2.m f64522d0;

    /* renamed from: e0, reason: collision with root package name */
    public boolean f64523e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f64524f0 = false;
    ...
    public final void X7() {
        ...
        el.a.V(nVar, s8Var.f114405n2);
        el.a.p0(nVar, (pb0.a) oaVar.f113834o1.get());
        el.a.s0(nVar, s8Var.l5());
        el.a.a1(nVar, s8Var.a6());
    }

    public final void c8() {
        if (this.f64522d0 == null) {
            this.f64522d0 = new ye2.m(super.getContext(), this);
            this.f64523e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f64523e0) {
            return null;
        }
        c8();
        return this.f64522d0;
    }
