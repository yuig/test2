...
public abstract class a extends nl1.d implements af2.c {
    ...
    public final Object f213a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f214b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.Z == null) {
            synchronized (this.f213a0) {
                try {
                    if (this.Z == null) {
                        this.Z = new h(this);
                    }
    ...
    public final void X7() {
        ...
        ig1.b.E0(dVar, (k) oaVar.f113921t1.get());
        ig1.b.w0(dVar, (vy.m) oaVar.M1.get());
    }
