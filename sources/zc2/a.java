...
public abstract class a extends com.pinterest.widget.configuration.a implements af2.c {
    ...
    public volatile ye2.h f141612a0;

    /* renamed from: b0, reason: collision with root package name */
    public final Object f141613b0 = new Object();

    /* renamed from: c0, reason: collision with root package name */
    public boolean f141614c0 = false;

    @Override // af2.c
    /* renamed from: W7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f141612a0 == null) {
            synchronized (this.f141613b0) {
                try {
                    if (this.f141612a0 == null) {
                        this.f141612a0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f141612a0;
    }
