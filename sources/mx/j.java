...
public abstract class j extends nl1.d implements af2.c {
    public m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f88467a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f88468b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f88467a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        j1.C0(hVar, (np1.j) oaVar.Y6.get());
        j1.y0(hVar, new l((z0) s8Var.f114255d.D0.get()));
        j1.t0(hVar, (z70.m) s8Var.f114387m.get());
        j1.u0(hVar, (pb0.a) oaVar.f113834o1.get());
    }
