...
public abstract class f1 extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f27111a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f27112b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f27111a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        m2.j1(zVar, (n72.b) oaVar.f113881qd.get());
        m2.p1(zVar, oaVar.a3());
    }
