...
public abstract class a extends k implements af2.c {
    ...
    public boolean f21989f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f21990g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f21991h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f21992i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f21990g0 == null) {
            synchronized (this.f21991h0) {
                try {
                    if (this.f21990g0 == null) {
                        this.f21990g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f21990g0;
    }

    public final void Z7() {
        if (this.f21988e0 == null) {
            this.f21988e0 = new m(super.getContext(), this);
            this.f21989f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        t.x0(eVar, (uk1.e) oaVar.f113702ga.get());
        t.E0(eVar, (i92.k) oaVar.f113921t1.get());
        t.J0(eVar, (v) s8Var.C.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f21989f0) {
            return null;
        }
        Z7();
        return this.f21988e0;
    }
