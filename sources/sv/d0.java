...
public abstract class d0 extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f115272a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f115273b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f115272a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        k3.z0(eVar, s8Var.h5());
        k3.y0(eVar, (pb0.a) oaVar.f113834o1.get());
        k3.A0(eVar, s8Var.l5());
    }
