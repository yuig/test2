...
public abstract class a1 extends h2 {

    /* renamed from: q1, reason: collision with root package name */
    public ye2.m f108107q1;

    /* renamed from: r1, reason: collision with root package name */
    public boolean f108108r1;

    /* renamed from: s1, reason: collision with root package name */
    public boolean f108109s1 = false;
    ...
    public final void T8() {
        ...
        this.f108109s1 = true;
        s0 s0Var = (s0) this;
        x8 x8Var = (x8) ((t0) generatedComponent());
        oa oaVar = x8Var.f114707a;
        s0Var.f91283h = oaVar.Ec;
        s0Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        kh2.d.f0(s0Var, oaVar.j2());
        kh2.d.x0(s0Var, (up0.l) oaVar.Rc.get());
        kh2.d.n0(s0Var);
        kh2.d.d0(s0Var, s8Var.o5());
        kh2.d.i0(s0Var, (d21.a) s8Var.f114317h2.get());
        kh2.d.k0(s0Var, (x02.i2) oaVar.F3.get());
        kh2.d.V(s0Var, (qh1.e) s8Var.P1.get());
        kh2.d.y0(s0Var, s8Var.L6());
        kh2.d.q0(s0Var, (lb0.r) oaVar.f113622c1.get());
        ve.h.T(s0Var, (t6) s8Var.Q2.get());
        ve.h.E(s0Var, (e6) s8Var.Q1.get());
    }

    @Override // rh1.f1, rh1.w0, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f108108r1) {
            return null;
        }
        l9();
        return this.f108107q1;
    }

    public final void l9() {
        if (this.f108107q1 == null) {
            this.f108107q1 = new ye2.m(super.getContext(), this);
            this.f108108r1 = ue.c.x(super.getContext());
        }
    }
