...
public final class k extends dl2.j implements Function2 {
    ...
    public final /* synthetic */ n f111185s;
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        return new k(this.f111185s, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i13 = this.f111184r;
        if (i13 == 0) {
            ue.c.H(obj);
            n nVar = this.f111185s;
            z viewLifecycleOwner = nVar.getViewLifecycleOwner();
