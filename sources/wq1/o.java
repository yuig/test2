...
public abstract class o extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f130846e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f130847f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f130848g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f130849h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f130850i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f130848g0 == null) {
            synchronized (this.f130849h0) {
                try {
                    if (this.f130848g0 == null) {
                        this.f130848g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f130848g0;
    }

    public final void Z7() {
        if (this.f130846e0 == null) {
            this.f130846e0 = new ye2.m(super.getContext(), this);
            this.f130847f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        t.C(fVar, (vy.m) oaVar.M1.get());
        t.q0(fVar, (uk1.e) oaVar.f113702ga.get());
        t.k0(fVar, (z) s8Var.W5.get());
        t.D0(fVar, (i92.k) oaVar.f113921t1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f130847f0) {
            return null;
        }
        Z7();
        return this.f130846e0;
    }
