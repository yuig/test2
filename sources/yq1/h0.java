...
public abstract class h0 extends yk1.k implements af2.c {

    /* renamed from: e0, reason: collision with root package name */
    public ye2.m f139860e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f139861f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f139862g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f139863h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f139864i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f139862g0 == null) {
            synchronized (this.f139863h0) {
                try {
                    if (this.f139862g0 == null) {
                        this.f139862g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f139862g0;
    }

    public final void Z7() {
        if (this.f139860e0 == null) {
            this.f139860e0 = new ye2.m(super.getContext(), this);
            this.f139861f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        this.f139864i0 = true;
        b1 b1Var = (b1) this;
        x8 x8Var = (x8) ((c1) generatedComponent());
        oa oaVar = x8Var.f114707a;
        b1Var.f91283h = oaVar.Ec;
        b1Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        kg.t.B0(b1Var, (uk1.e) oaVar.f113702ga.get());
        kg.t.w0(b1Var, (so.i0) s8Var.f114454q6.get());
        kg.t.f0(b1Var, (il1.a) s8Var.f114581z.get());
        kg.t.I0(b1Var);
        kg.t.Y(b1Var, (fr1.c) oaVar.f113821n6.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f139861f0) {
            return null;
        }
        Z7();
        return this.f139860e0;
    }
