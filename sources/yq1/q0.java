...
public abstract class q0 extends nl1.d implements af2.c {
    public ye2.m X;
    public boolean Y;
    public volatile ye2.h Z;

    /* renamed from: a0, reason: collision with root package name */
    public final Object f139958a0 = new Object();

    /* renamed from: b0, reason: collision with root package name */
    public boolean f139959b0 = false;

    @Override // af2.c
    /* renamed from: V7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.Z == null) {
            synchronized (this.f139958a0) {
                try {
                    if (this.Z == null) {
    ...
    public final void X7() {
        ...
        this.f139959b0 = true;
        s2 s2Var = (s2) this;
        x8 x8Var = (x8) ((t2) generatedComponent());
        oa oaVar = x8Var.f114707a;
        s2Var.f91283h = oaVar.Ec;
        s2Var.f91284i = (x2) oaVar.f113800m3.get();
        ...
        kh2.j.s0(s2Var, (vy.m) oaVar.M1.get());
        kh2.j.u0(s2Var, oaVar.a2());
        kh2.j.k0(s2Var, (mr1.a) oaVar.B6.get());
        kh2.j.v0(s2Var, s8Var.b5());
        kh2.j.X0(s2Var, s8Var.M5());
        kh2.j.h0(s2Var, s8Var.Y4());
        kh2.j.c1(s2Var, (gz1.b) oaVar.C1.get());
        kh2.j.A1(s2Var, (h9) oaVar.f113716h6.get());
    }
