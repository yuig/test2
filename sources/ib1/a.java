...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f72013v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f72014w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f72015x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f72016y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f72014w0 == null) {
            synchronized (this.f72015x0) {
                try {
                    if (this.f72014w0 == null) {
                        this.f72014w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f72014w0;
    }

    public final void S8() {
        if (this.f72012u0 == null) {
            this.f72012u0 = new m(super.getContext(), this);
            this.f72013v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        kh2.d.s0(eVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f72013v0) {
            return null;
        }
        S8();
        return this.f72012u0;
    }
