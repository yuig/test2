...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f136193v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f136194w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f136195x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f136196y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f136194w0 == null) {
            synchronized (this.f136195x0) {
                try {
                    if (this.f136194w0 == null) {
                        this.f136194w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f136194w0;
    }

    public final void S8() {
        if (this.f136192u0 == null) {
            this.f136192u0 = new m(super.getContext(), this);
            this.f136193v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        kh2.d.g0(eVar, s8Var.b6());
        kh2.d.e0(eVar, s8Var.d6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f136193v0) {
            return null;
        }
        S8();
        return this.f136192u0;
    }
