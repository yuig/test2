...
public abstract class f<D extends yq0.a0> extends yq0.b0<D> implements af2.c {
    ...
    public ye2.m f115433u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f115434v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f115435w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f115436x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f115437y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f115435w0 == null) {
            synchronized (this.f115436x0) {
                try {
                    if (this.f115435w0 == null) {
                        this.f115435w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f115435w0;
    }

    public final void S8() {
        if (this.f115433u0 == null) {
            this.f115433u0 = new ye2.m(super.getContext(), this);
            this.f115434v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        dn.c.W(nVar, (uk1.e) oaVar.f113702ga.get());
        dn.c.M(nVar, oaVar.Z7);
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f115434v0) {
            return null;
        }
        S8();
        return this.f115433u0;
    }
