...
public final class h extends d {
        ...
        if (list != null) {
            ...
            if (list2 != null) {
                ...
                for (Object obj : list2) {
                    ...
                    RectF rectF = new RectF(i14 % 2 == 0 ? this.f142022z + this.F : 0, i14 == 0 ? i13 : this.A + i13 + this.F, r6 + this.f142022z, r7 + this.A);
                    List list3 = this.E;
                    if (list3 != null) {
                        list3.add(rectF);
                    }
    ...
    public final void n(int i13, int i14) {
        ...
        int i16 = this.F;
        this.f142010n = ((i13 <= (i16 / 2) + i15 ? 0 : 1) + (i14 > (i16 / 2) + this.A ? 2 : 0)) - 1;
    }
