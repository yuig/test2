...
public abstract class a extends k implements af2.c {
    ...
    public boolean f21417f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f21418g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f21419h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f21420i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f21418g0 == null) {
            synchronized (this.f21419h0) {
                try {
                    if (this.f21418g0 == null) {
                        this.f21418g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f21418g0;
    }

    public final void Z7() {
        if (this.f21416e0 == null) {
            this.f21416e0 = new m(super.getContext(), this);
            this.f21417f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        pe.i.w0(gVar, (uk1.e) oaVar.f113702ga.get());
        pe.i.D0(gVar, (t1) s8Var.f114396m8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f21417f0) {
            return null;
        }
        Z7();
        return this.f21416e0;
    }
