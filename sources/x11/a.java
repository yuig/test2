...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f131569v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f131570w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f131571x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f131572y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f131570w0 == null) {
            synchronized (this.f131571x0) {
                try {
                    if (this.f131570w0 == null) {
                        this.f131570w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f131570w0;
    }

    public final void S8() {
        if (this.f131568u0 == null) {
            this.f131568u0 = new m(super.getContext(), this);
            this.f131569v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        pp2.a.p0(cVar, (uk1.e) oaVar.f113702ga.get());
        pp2.a.S(cVar, (q11.a) s8Var.P3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f131569v0) {
            return null;
        }
        S8();
        return this.f131568u0;
    }
