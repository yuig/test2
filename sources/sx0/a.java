...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f115613v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f115614w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f115615x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f115616y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f115614w0 == null) {
            synchronized (this.f115615x0) {
                try {
                    if (this.f115614w0 == null) {
                        this.f115614w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
    ...
    public final void S8() {
        if (this.f115612u0 == null) {
            this.f115612u0 = new m(super.getContext(), this);
            this.f115613v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        r.E(gVar, (zf0.f) oaVar.f113723hd.get());
        r.L(gVar, (w1) oaVar.Te.get());
        r.M(gVar, (w12.b) s8Var.O6.get());
        r.I(gVar, oa.R0(oaVar));
        r.G(gVar, s8Var.c6());
        r.U(gVar, (uk1.e) oaVar.f113702ga.get());
        r.K(gVar, s8Var.f114462r);
        r.O(gVar, (g0) oaVar.f113590a4.get());
        r.z(gVar, (oc.c) oaVar.f113907s5.get());
        r.A(gVar, oaVar.q2());
        r.B(gVar, s8Var.p5());
        r.C(gVar, a02.e.H4());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f115613v0) {
            return null;
        }
        S8();
        return this.f115612u0;
    }
