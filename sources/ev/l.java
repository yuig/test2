...
public abstract class l extends yk1.k implements af2.c {
    ...
    public boolean f60228f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f60229g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f60230h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f60231i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f60229g0 == null) {
            synchronized (this.f60230h0) {
                try {
                    if (this.f60229g0 == null) {
                        this.f60229g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f60229g0;
    }

    public final void Z7() {
        if (this.f60227e0 == null) {
            this.f60227e0 = new m(super.getContext(), this);
            this.f60228f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        s0.f0(hVar, (mo1.d) oaVar.D5.get());
        s0.n0(hVar, (so.d1) s8Var.f114300g0.get());
        s0.O(hVar, oaVar.p2());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f60228f0) {
            return null;
        }
        Z7();
        return this.f60227e0;
    }
