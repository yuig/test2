...
public abstract class d {
    ...
    public static final Type[] f100580a = new Type[0];
    ...
    public static void b(Type type) {
        a0.A(((type instanceof Class) && ((Class) type).isPrimitive()) ? false : true);
    }
    ...
    /* JADX WARN: Type inference failed for: r11v3, types: [pm.c] */
    /* JADX WARN: Type inference failed for: r11v4, types: [pm.c] */
    ...
    */
    public static java.lang.reflect.Type g(java.lang.reflect.Type r9, java.lang.Class r10, java.lang.reflect.Type r11, java.util.HashMap r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: pm.d.g(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.HashMap):java.lang.reflect.Type");
    }

    public static c h(Type type) {
        return new c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, f100580a);
    }

    public static c i(Type type) {
