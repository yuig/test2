...
public abstract class a extends d implements af2.c {
    ...
    public boolean f117456d1;

    /* renamed from: e1, reason: collision with root package name */
    public volatile h f117457e1;

    /* renamed from: f1, reason: collision with root package name */
    public final Object f117458f1 = new Object();

    /* renamed from: g1, reason: collision with root package name */
    public boolean f117459g1 = false;

    public final void A9() {
        if (this.f117455c1 == null) {
            this.f117455c1 = new m(super.getContext(), this);
            this.f117456d1 = ue.c.x(super.getContext());
        }
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f117456d1) {
            return null;
        }
        A9();
        return this.f117455c1;
    }
    ...
    public final h componentManager() {
        if (this.f117457e1 == null) {
            synchronized (this.f117458f1) {
                try {
                    if (this.f117457e1 == null) {
                        this.f117457e1 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f117457e1;
    }

    @Override // androidx.fragment.app.Fragment
    public final void onAttach(Activity activity) {
        super.onAttach(activity);
        m mVar = this.f117455c1;
