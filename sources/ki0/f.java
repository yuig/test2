...
public abstract class f extends k implements af2.c {
    ...
    public boolean f79794f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile h f79795g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f79796h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f79797i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f79795g0 == null) {
            synchronized (this.f79796h0) {
                try {
                    if (this.f79795g0 == null) {
                        this.f79795g0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f79795g0;
    }

    public final void Z7() {
        if (this.f79793e0 == null) {
            this.f79793e0 = new m(super.getContext(), this);
            this.f79794f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        j.i1(cVar, (mo1.d) oaVar.D5.get());
        j.i2(cVar, (i92.k) oaVar.f113921t1.get());
        j.L1(cVar, (uk1.e) oaVar.f113702ga.get());
        j.l2(cVar, (UserDeserializer) oaVar.f113905s3.get());
        j.j0(cVar, (mr1.a) oaVar.B6.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f79794f0) {
            return null;
        }
        Z7();
        return this.f79793e0;
    }
