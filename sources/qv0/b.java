...
public abstract class b<D extends yq0.a0> extends yq0.b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f105152u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f105153v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f105154w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f105155x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f105156y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f105154w0 == null) {
            synchronized (this.f105155x0) {
                try {
                    if (this.f105154w0 == null) {
                        this.f105154w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f105154w0;
    }

    public final void S8() {
        if (this.f105152u0 == null) {
            this.f105152u0 = new ye2.m(super.getContext(), this);
            this.f105153v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        el.a.B1(jVar, (so.m) s8Var.f114542w5.get());
        el.a.z0(jVar, (ag1.b) oaVar.Z7.get());
        el.a.T0(jVar, (ag1.h) oaVar.K8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f105153v0) {
            return null;
        }
        S8();
        return this.f105152u0;
    }
