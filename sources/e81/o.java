...
public abstract class o extends yk1.k implements af2.c {
    ...
    public ye2.m f57810e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f57811f0;

    /* renamed from: g0, reason: collision with root package name */
    public volatile ye2.h f57812g0;

    /* renamed from: h0, reason: collision with root package name */
    public final Object f57813h0 = new Object();

    /* renamed from: i0, reason: collision with root package name */
    public boolean f57814i0 = false;

    @Override // af2.c
    /* renamed from: Y7, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f57812g0 == null) {
            synchronized (this.f57813h0) {
                try {
                    if (this.f57812g0 == null) {
                        this.f57812g0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f57812g0;
    }

    public final void Z7() {
        if (this.f57810e0 == null) {
            this.f57810e0 = new ye2.m(super.getContext(), this);
            this.f57811f0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void a8() {
        ...
        r.G0(dVar, (a4) s8Var.f114297fc.get());
        r.L0(dVar, (uk1.e) oaVar.f113702ga.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f57811f0) {
            return null;
        }
        Z7();
        return this.f57810e0;
    }
