...
public abstract class a extends jd1.d implements af2.c {
    ...
    public boolean f72223d1;

    /* renamed from: e1, reason: collision with root package name */
    public volatile h f72224e1;

    /* renamed from: f1, reason: collision with root package name */
    public final Object f72225f1 = new Object();

    /* renamed from: g1, reason: collision with root package name */
    public boolean f72226g1 = false;

    public final void A9() {
        if (this.f72222c1 == null) {
            this.f72222c1 = new m(super.getContext(), this);
            this.f72223d1 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void B9() {
        ...
        kh2.d.Y(bVar, (nr0.m) s8Var.f114506u.get());
        kh2.d.z0(bVar, (y3) s8Var.Pb.get());
        kh2.d.b0(bVar, s8Var.E6());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f72223d1) {
            return null;
        }
        A9();
        return this.f72222c1;
    }
    ...
    public final h componentManager() {
        if (this.f72224e1 == null) {
            synchronized (this.f72225f1) {
                try {
                    if (this.f72224e1 == null) {
                        this.f72224e1 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f72224e1;
    }

    @Override // androidx.fragment.app.Fragment
    public final void onAttach(Activity activity) {
        super.onAttach(activity);
        m mVar = this.f72222c1;
