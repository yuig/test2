...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f97514v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f97515w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f97516x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f97517y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f97515w0 == null) {
            synchronized (this.f97516x0) {
                try {
                    if (this.f97515w0 == null) {
                        this.f97515w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f97515w0;
    }

    public final void S8() {
        if (this.f97513u0 == null) {
            this.f97513u0 = new m(super.getContext(), this);
            this.f97514v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        c3.a0(iVar, (t) oaVar.Y7.get());
        c3.Q(iVar, (ag1.b) oaVar.Z7.get());
        c3.U(iVar, (x7) s8Var.f114556x4.get());
        c3.b0(iVar, (i92.k) oaVar.f113921t1.get());
        c3.P(iVar, (x0) oaVar.f113765k3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f97514v0) {
            return null;
        }
        S8();
        return this.f97513u0;
    }
