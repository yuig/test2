...
public abstract class l<D extends yq0.a0> extends yq0.b0<D> implements af2.c {

    /* renamed from: u0, reason: collision with root package name */
    public ye2.m f74755u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f74756v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f74757w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f74758x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f74759y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f74757w0 == null) {
            synchronized (this.f74758x0) {
                try {
                    if (this.f74757w0 == null) {
                        this.f74757w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f74757w0;
    }

    public final void S8() {
        if (this.f74755u0 == null) {
            this.f74755u0 = new ye2.m(super.getContext(), this);
            this.f74756v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        kh2.d.t0(eVar, (uk1.e) oaVar.f113702ga.get());
        kh2.d.Q(eVar, (f2) s8Var.L8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f74756v0) {
            return null;
        }
        S8();
        return this.f74755u0;
    }
