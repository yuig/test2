...
public abstract class a extends l {
    ...
    public boolean f116438e0;

    /* renamed from: f0, reason: collision with root package name */
    public boolean f116439f0 = false;
    ...
    public final void X7() {
        ...
        dVar.f91299x = (h) oaVar.f113797m0.get();
        dVar.f91300y = (uj2.q) oaVar.f113947u9.get();
        dVar.f91301z = (a80.a) oaVar.Wc.get();
        dVar.A = (z70.f) oaVar.f113764k2.get();
        ph.a.j0(dVar, s8Var.e5());
    }

    public final void c8() {
        if (this.f116437d0 == null) {
            this.f116437d0 = new m(super.getContext(), this);
            this.f116438e0 = ue.c.x(super.getContext());
        }
    }

    @Override // mm1.o, androidx.fragment.app.Fragment
    public final Context getContext() {
        if (super.getContext() == null && !this.f116438e0) {
            return null;
        }
        c8();
        return this.f116437d0;
    }
