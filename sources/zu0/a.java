...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f142808v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f142809w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f142810x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f142811y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f142809w0 == null) {
            synchronized (this.f142810x0) {
                try {
                    if (this.f142809w0 == null) {
                        this.f142809w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f142809w0;
    }

    public final void S8() {
        if (this.f142807u0 == null) {
            this.f142807u0 = new m(super.getContext(), this);
            this.f142808v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        m2.q1(gVar, (i8) s8Var.R4.get());
        m2.o1(gVar, (m20.b) oaVar.F8.get());
        m2.s1(gVar, (k) oaVar.f113921t1.get());
        m2.l1(gVar, (ag1.h) oaVar.K8.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f142808v0) {
            return null;
        }
        S8();
        return this.f142807u0;
    }
