...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f27443v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f27444w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f27445x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f27446y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f27444w0 == null) {
            synchronized (this.f27445x0) {
                try {
                    if (this.f27444w0 == null) {
                        this.f27444w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f27444w0;
    }

    public final void S8() {
        if (this.f27442u0 == null) {
            this.f27442u0 = new m(super.getContext(), this);
            this.f27443v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        c0.d.y1(dVar, (uk1.e) oaVar.f113702ga.get());
        c0.d.A0(dVar, (oc.c) oaVar.f113907s5.get());
        c0.d.R0(dVar, s8Var.C6());
        c0.d.x1(dVar, (r) oaVar.f113622c1.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f27443v0) {
            return null;
        }
        S8();
        return this.f27442u0;
    }
