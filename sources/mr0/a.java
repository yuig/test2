...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public boolean f88079v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile h f88080w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f88081x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f88082y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final h componentManager() {
        if (this.f88080w0 == null) {
            synchronized (this.f88081x0) {
                try {
                    if (this.f88080w0 == null) {
                        this.f88080w0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f88080w0;
    }

    public final void S8() {
        if (this.f88078u0 == null) {
            this.f88078u0 = new m(super.getContext(), this);
            this.f88079v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void T8() {
        ...
        r.T(eVar, (uk1.e) oaVar.f113702ga.get());
        r.W(eVar, (n7) s8Var.K3.get());
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f88079v0) {
            return null;
        }
        S8();
        return this.f88078u0;
    }
