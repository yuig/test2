...
public final class h extends dl2.j implements Function2 {
    ...
    public final /* synthetic */ j f130476s;
    ...
    public final bl2.c create(Object obj, bl2.c cVar) {
        return new h(this.f130476s, cVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        int i13 = this.f130475r;
        if (i13 == 0) {
            ue.c.H(obj);
            j jVar = this.f130476s;
            z viewLifecycleOwner = jVar.getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
            r rVar = r.STARTED;
            g gVar = new g(jVar, null);
            this.f130475r = 1;
            if (m0.f0(viewLifecycleOwner, rVar, gVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i13 != 1) {
