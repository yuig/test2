...
public abstract class f<Presenter extends g, Sheet extends i> extends m<Presenter, Sheet> implements af2.c {
    ...
    public ye2.m f56266v0;

    /* renamed from: w0, reason: collision with root package name */
    public boolean f56267w0;

    /* renamed from: x0, reason: collision with root package name */
    public volatile h f56268x0;

    /* renamed from: y0, reason: collision with root package name */
    public final Object f56269y0 = new Object();

    /* renamed from: z0, reason: collision with root package name */
    public boolean f56270z0 = false;
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f56267w0) {
            return null;
        }
        j8();
        return this.f56266v0;
    }
    ...
    public final h componentManager() {
        if (this.f56268x0 == null) {
            synchronized (this.f56269y0) {
                try {
                    if (this.f56268x0 == null) {
                        this.f56268x0 = new h(this);
                    }
                } finally {
                }
            }
        }
        return this.f56268x0;
    }

    public final void j8() {
        if (this.f56266v0 == null) {
            this.f56266v0 = new ye2.m(super.getContext(), this);
            this.f56267w0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final void k8() {
        ...
        p2.D0(dVar, oaVar.w2());
        k3.q0(dVar, (j7) s8Var.L.get());
        k3.i1(dVar, (kt.a) s8Var.M.get());
        k3.u0(dVar, s8Var.e5());
    }
