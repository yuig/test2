...
public abstract class a<D extends a0> extends b0<D> implements af2.c {
    ...
    public ye2.m f138535u0;

    /* renamed from: v0, reason: collision with root package name */
    public boolean f138536v0;

    /* renamed from: w0, reason: collision with root package name */
    public volatile ye2.h f138537w0;

    /* renamed from: x0, reason: collision with root package name */
    public final Object f138538x0 = new Object();

    /* renamed from: y0, reason: collision with root package name */
    public boolean f138539y0 = false;

    @Override // af2.c
    /* renamed from: R8, reason: merged with bridge method [inline-methods] */
    public final ye2.h componentManager() {
        if (this.f138537w0 == null) {
            synchronized (this.f138538x0) {
                try {
                    if (this.f138537w0 == null) {
                        this.f138537w0 = new ye2.h(this);
                    }
                } finally {
                }
            }
        }
        return this.f138537w0;
    }

    public final void S8() {
        if (this.f138535u0 == null) {
            this.f138535u0 = new ye2.m(super.getContext(), this);
            this.f138536v0 = ue.c.x(super.getContext());
        }
    }
    ...
    public final Context getContext() {
        if (super.getContext() == null && !this.f138536v0) {
            return null;
        }
        S8();
        return this.f138535u0;
    }
