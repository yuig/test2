...
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u00012\b\u0012\u0004\u0012\u00020\u00020\u0003B\t\b\u0007¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"Lyb1/j;", "Lyq0/b0;", "", "Lcom/pinterest/feature/settings/permissions/d;", "<init>", "()V", "permissions_release"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes2.dex */
public final class j extends b<Object> implements com.pinterest.feature.settings.permissions.d {
    public static final /* synthetic */ int F0 = 0;
    public x10.d A0;
    public com.pinterest.feature.settings.permissions.c B0;
    public final d4 C0 = d4.SETTINGS;
    public final a4 D0 = a4.PERMISSIONS_SETTINGS;
    public View E0;

    /* renamed from: z0, reason: collision with root package name */
    public uk1.e f138565z0;
    ...
    public final void Q8(z adapter) {
        ...
        adapter.G(1, new i(this, 0));
        adapter.G(2, new i(this, 1));
        adapter.G(15, new i(this, 2));
        adapter.G(3, new i(this, 3));
        adapter.G(0, new i(this, 4));
        adapter.G(0, new i(this, 5));
    }

    @Override // yk1.k
    public final yk1.m V7() {
        uk1.e eVar = this.f138565z0;
        if (eVar == null) {
        ...
        x10.d dVar = this.A0;
        if (dVar != null) {
            return new xb1.d(g13, p73, f73, aVar, dVar, A7());
        }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (settingsRoundHeaderView != null) {
            ...
            settingsRoundHeaderView.g0(new x91.k(this, 23));
            settingsRoundHeaderView.k0(c52.e.settings_message_settings_title);
